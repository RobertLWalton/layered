...
\\\cline{5-6}
	& math  &		& 	     & \TT{-}	& subtraction  &
\\\cline{2-3}\cline{5-7}
	& code  & \ttkey{infix}	&            & \TT{OR\#} & binary or    & B
\\\cline{5-6}
	&	&		& 	     & \TT{AND\#} & binary and   &
\\\cline{5-6}
	&	&		& 	     & \TT{XOR\#}
...
Parser Command				& \shortstack{
                                          Given\\Qualifiers}
\\\hline
\tt define operator "OR\# =" [code] infix line & {\tt + code} \\
\tt ~~~~~~~with precedence 1000 \\
\tt ~~~~~~~with binary reformatter \\
\tt define operator "AND\# =" [code] infix line & {\tt + code} \\
\tt ~~~~~~~with precedence 1000 \\
\tt ~~~~~~~with binary reformatter \\
...
\tt ~~~~~~~with binary reformatter \\
\\[1ex]
\tt define operator "OR\#" [code] infix & {\tt + code} \\
\tt ~~~~~~~with precedence 13000 \\
\tt ~~~~~~~with infix reformatter ( "OR\#" ) \\
\tt define operator "AND\#" [code] infix & {\tt + code} \\
\tt ~~~~~~~with precedence 13000 \\
\tt ~~~~~~~with infix reformatter ( "AND\#" ) \\
...
\\[1ex]
\tt define operator "NOT\#" [code] prefix & {\tt + code} \\
\tt ~~~~~~~with precedence 100000 \\
\tt ~~~~~~~with unary reformatter \\
\end{tabular}
\end{center}
