...
\ttmkey{control operators}{parser standard flag} &
    ...
    (\pagref{STANDARD-CONTROL-OPERATORS},
     \pagref{STANDARD-FUNCTION-OR-CONTROL-OPERATORS}).  [code]
\\
\ttmkey{function operators}{parser standard flag} &
    Executes function operator definitions
    (\pagref{STANDARD-FUNCTION-OPERATORS},
     \pagref{STANDARD-FUNCTION-OR-CONTROL-OPERATORS}).  [code]
\\
...
\begin{tabular}{l@{\hspace*{0.2in}}l}
\multicolumn{2}{c}
{\bf Standard `\ttkey{function operators}'\label{STANDARD-FUNCTION-OPERATORS}
     Component} \\
\multicolumn{2}{c}
{\bf Operator Definition Parser Commands}
\\[1ex]
Parser Command				& \shortstack{
                                          Given\\Qualifiers}
\\\hline
\tt define operator "function" [code] prefix line & {\tt + code} \\
\tt ~~~~~~~with precedence 0 \\
\tt ~~~~~~~with control reformatter ( ":", has condition ) \\
\tt define operator "return" [code] initial line & {\tt + code} \\
\tt ~~~~~~~with precedence 0 \\
\tt ~~~~~~~with exit reformatter \\
\end{tabular}
\end{center}
...
\begin{tabular}{l@{\hspace*{0.2in}}l}
\multicolumn{2}{c}
{\bf Standard `\ttlkey{function or control}{operators}'%
    \label{STANDARD-FUNCTION-OR-CONTROL-OPERATORS}
     Component} \\
\multicolumn{2}{c}
{\bf Operator Definition Parser Commands}
\\[1ex]
