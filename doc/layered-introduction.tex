...
\multicolumn{1}{c}{This Command Requires at Least One of
                   {\tt + code, + text, + math}} \\
\multicolumn{1}{c}{Selectors with Missing Qualifiers are Deleted
                   from the Command}
\\[1ex]
...
\\[1ex]
\multicolumn{1}{c}
{Selectors with Missing Qualifiers are Deleted
                   from the Commands}
\\[1ex]
...
\\[2ex]
\begin{tabular}{l}
\multicolumn{1}{c}{The Following Commands Require {\tt + text}}
\\[1ex]
