...
\end{center}
are all equivalent.  Second, in {\em attribute-flags} the
items and indices may be mixed in any way and order and
space is not required after commas, so that:
\begin{center}
\TT{\{T: a[PQ@*+, 85, 203] | X Y Z | \}} \\
\TT{\{T: a[PQ@*+,85,203] | X Y Z | \}} \\
\TT{\{T: a[85,PQ@*+,203] | X Y Z | \}} \\
\TT{\{T: a[85,PQ,203,@*+] | X Y Z | \}} \\
