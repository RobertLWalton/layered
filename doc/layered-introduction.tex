...
is marked as a paragraph header (as opposed to begin marked
as a line header).

If an explicit paragraph header is recognized at the beginning
of a logical line, it is used to reset the data used
line beginning algorithm, and then that algorithm looks for
a following line header.  If no explicit paragraph header is
recognized, the line is outside any unindented paragraph, and
the algorithm looks for a line header. 
