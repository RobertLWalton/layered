...
Any prefix operator whose precedence is less than $P$ is ignored.
...
is a postfix operator, insert the error nofix operator of precedence
...
\item[Loop Step 6:]
If $C=N$ or the operator found in Loop Step 1 or generated by Loop Step 2
has precedence less than or equal to $P$,
