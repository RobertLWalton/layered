...
becoming a MIN object
{\em attribute-initiator} \TT{.ini\-tiator},
\TT{min::\EOL INDENTED\_\EOL PARAGRAPH()} \TT{.ter\-min\-ator},
and logical line elements.  This reformatter
...
references to the object.  Similarly if the new value is a
\underline{non-identifier} string, whether quoted or not.
However, if the new value is not an object or non-identifier string,
...
the {\em element-list} be as intended.
