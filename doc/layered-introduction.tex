...
The {\em bracket-type-options} \underline{are} used to set the options
at the beginning of the {\em prefix-(n+1)-list} following a
{\em prefix-n} that has the bracket type.
