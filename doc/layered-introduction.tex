...
\begin{itemize}
\item[(2A)]
A sequence of operators at the beginning of the expression
must have the form:
\begin{center}
\{ \em {nofix-operator}\PLUS{} \em{infix-operator} \}\STAR{}
\em {nofix-operator}\STAR{} \em{prefix-operator}\STAR{}
\end{center}
where the infix operators have lower precedence than any nofix
operators adjacent to them.
\item[(2A)]
A sequence of operators in the middle of the expression
must have the form:
\begin{center}
TBD
\end{center}
