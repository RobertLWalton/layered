...
At any time there is also a
`\key{current default paragraph header}', which if present
(not equal to \TT{MISSING}), is inserted at the beginning of
...
More details on paragraph headers are given in
