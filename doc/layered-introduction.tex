...
The above rules lead to the fixity rewrite rules
in figure \ref{FIXITY-REWRITE-RULES}.  In these
`ambiguity-error' means there will be more than one
way to assign fixity to the expression operators consistent
with the above rules; `possibility-error'
...
\begin{tabular}{r}
\ldots{} \\
\ldots{} infix-or-prefix \\
\ldots{} infix-or-postfix \\
\ldots{} prefix-or-postfix\PLUS{} \\
\ldots{} infix-or-postfix prefix-or-postfix\PLUS{} \\
\end{tabular}
\end{center}

where \ldots{}~denotes a sequence of non-operators and non-ambiguous
operators.  An unbounded string of prefix-or-postfix operators
will collapse into a string of all prefix operators
or a string of all postfix operators before or at the end of the
expression.
