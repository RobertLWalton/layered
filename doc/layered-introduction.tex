...
selectors associated with each pass.  After the top level pass
...
top & This refers to the bracketed subexpression recognition pass which is
...
and installs the parser pass in the parser pass stack at the
location specified.
