...
C/C++ numbers convertable to IEEE double precision
are just the {\em numeric-word}, {\em natural}, and {\em number} lexemes,
except the lexemes cannot end in a {\em decimal-point} and
...
\\[1ex]  
\begin{tabular}{p{1in}p{4.5in}}
		& Note that lexemes with a MIN number value may not
		  reproduce the lexeme characters when printed.
		  For example, the lexeme {\tt 1e+300} will be stored
		  as plus infinity and print as {\tt Inf}.
\end{tabular}
\\[1ex]  
\begin{tabular}{p{1in}p{4.5in}}
