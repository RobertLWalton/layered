...
Figures~\itemref{OPTION-NAMES-1}
and~\itemref{OPTION-NAMES-2}:
...
\hspace*{0.3in}\begin{tabular}{rl}
    & \TT{define}\ttmindex{define top level}{parser command}
      ...
      ~ \begin{tabular}[t]{@{}l@{}}
       ...
       [ \TT{with parsing options} ~ {\em top-level-option-spec} ] \\{}
...
\\[0.3ex]
\emkey{top-level-option-spec} ::=
    \begin{tabular}[t]{l}
    {\em option-spec} with only `\TT{end at \ldots}' \\
    and `\TT{enable indented paragraph}' options
	~~~ [\pagref{OPTION-SPEC}]
    \end{tabular}
\\[0.3ex]
...
parsing paragraph options
			& 4 bits	& \pagref{PARAGRAPH-OPTIONS} \\
...
\emkey{bracket-options}\label{BRACKET-OPTIONS} ::=
    ...
    other than `\TT{end at line separator}'
	~~~ [\pagref{OPTION-SPEC}]
    \end{tabular}
\\[0.5ex]
...
\emkey{indentation-mark-options} ::=
    \begin{tabular}[t]{l}
    {\em option-spec} with only `\TT{end at \ldots}' options \\
    and `\TT{enable indented paragraph}' option
	~~~ [\pagref{OPTION-SPEC}]
    \end{tabular}
\\[0.5ex]
