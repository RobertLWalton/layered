...
lexical scan performed to convert a logical line into lexemes.
This scan can introduce paragraph or line headers based on
...
\ttmkey{type}{of symbol table entry}
		& The type of the definition.  Each parser pass has
		  ...
		  \TT{opening bracket}, \TT{closing bracket},
