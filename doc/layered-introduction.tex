...
The following are keys in the bracketed subexpression
parser symbol table:
\begin{center}
{\em typed-opening} \\
{\em typed-middle} \\
{\em typed-closing} \\
\end{center}
The {\em typed-opening} and {\em typed-closing} are used to
delimit the {\em typed-bracketed-subexpression}.
The {\em typed-middle} is used to change selectors for
subexpressions recognized as part of the {\em element-list}.

The following are keys in a separate symbol used to post-process
a {\em typed-bracketed-subexpression} after it has been delmited:
\begin{center}
{\em typed-middle} \\
{\em typed-attribute-begin} \\
...
{\em typed-attribute-flags-opening/separator/closing}, \\
and {\em typed-attribute-multivalue-opening/separator/closing}
are symbol table keys specified by a
