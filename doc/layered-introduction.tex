...
\hspace*{-0.2in}\ttmkey{implied paragraph header}{line variable}\\
    ...
    is found at the beginning of a logical line that is immediately
    preceded by a blank line or the beginning of the containing
    indented paragraph (which comment lines possibly intervening),
