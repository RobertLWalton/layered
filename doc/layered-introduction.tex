...
A subexpression with \TT{.initiator} $I$ is replaced by the label
\TT{[< $I$ subexp >]}, except that a subexpression with
\underline{no} \TT{.initiator} is replaced by \TT{[< ( subexp >]}
...
For a \TT{PRIM::func} object label is the primary vector
