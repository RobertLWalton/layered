...
in Figures \ref{FIXITY-REWRITE-RULES-1} and \ref{FIXITY-REWRITE-RULES-2}
that determine the fixity
...
\end{center}
\vspace*{-3ex}
\caption{Fixity Rewrite Rules: Part 1 of 2}
...
\\[2ex]
\begin{tabular}{rl}
\SUP{H}  & means operator has higher precedence that preceeding operator\\[1ex]
\SUP{--H} & means operator has precedence lower than or equal to precedence of
           preceeding operator\\[1ex]
\SUP{A}  & means operator is afix\\[1ex]
\SUP{--A} & means operator is \underline{not} afix
\end{tabular}
\end{center}
\vspace*{-3ex}
\caption{Fixity Rewrite Rules: Part 2 of 2}
