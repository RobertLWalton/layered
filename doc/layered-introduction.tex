...
that have the {\tt .initiator} attribute {\tt "\BACKSLASH""}
...
\hspace*{-0.2in}\ttdmkey{arguments}{subexpression attribute}\\
    ...
    or of a {\em named-operator}.  The arguments are the elements of
    the object, and the object has no syntax attributes.  Each argument is
...
\hspace*{-0.2in}\ttdmkey{keys}{subexpression attribute}\\
    ...
    {\em named-separator} of the {\em opening-named-bracket}
...
The general syntax of {\em parser-unnamed-bracket-commands} is:

\begin{indpar}[0.1in]
\emkey{parser-unnamed-bracket-command}%
\label{PARSER-UNNAMED-BRACKET-COMMAND}
\\
    \hspace*{0.2in}
    \begin{tabular}[t]{rll}
...
\emkey{argument} ::= {\em unnamed-bracketed-subexpression}
                 $|$ {\em quoted-string}
\\[0.5ex]
\emkey{named-separator} ::= as defined by a
    {\em parser-named-bracket-command} (\pagref{PARSER-NAMED-BRACKET-COMMAND})
\\[0.5ex]
