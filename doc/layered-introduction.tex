...
\begin{figure*}[!p]
\begin{center}
\begin{tabular}{|l|r|ll@{\hspace*{1em}}l@{\hspace*{1em}}ll|}
\hline
selec-  & prece-  &             &            &            &            & \\
~tors   & ~dence  & reformatter	& flags	     & operator   & meaning    & class
\\\hline
code    & 1000	& \TT{binary}	& \TT{infix} & \ttkey{=}  & assignment & S \\
     	...
     	&	&            	&            & \ttkey{\textasciitilde
	                                              \textasciitilde=}
	                                                  & flip    & B 
\\\hline
math    & 1000	& \TT{binary}	& \TT{infix} & \ttkey{=}  & assignment & S
\\\hline
...
\\\cline{2-7}
	...
	&	&		& 	     & \TT{-}	& subtraction  & A
\\\cline{3-7}
	&	& \ttkey{infix}	& \TT{infix} & \TT{|}	& binary or    & B \\
	&	&		& 	     & \TT{\&}	& binary and   & B \\
	&	&		& 	     & \TT{\textasciitilde
	                                           \textasciitilde}
						        & binary exclusive or
							               & B
\\\cline{2-7}
	& 5100	& \ttkey{binary} & \TT{infix} & \TT{/}	& division     & A
\\\cline{2-7}
	& 5200	& \ttkey{infix}	& \TT{infix} & \TT{*}   & multiplication & A
\\\cline{2-7}
...
\\\cline{2-7}
	...
	&	&		& 	      & \TT{-}	& negation     & A 
\\\cline{3-7}
	&    	& \ttkey{unary}	& \TT{prefix} & \TT{\textasciitilde}
	                                                & binary complement
							               & B
\\\hline
\end{tabular}
