...
However, the selectors modified by a bracket type type entry for a
{\em prefix-m} are always the selectors in effect at the beginning
of the {\em prefix-m-list} containing the {\em prefix-m}, even though
these selectors are not used to parse the {\em prefix-m} or
look up its bracket type table entry if the {\em prefix-m}
does not begin its containing {\em prefix-m-list}.
