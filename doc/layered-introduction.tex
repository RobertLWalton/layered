...
\label{FIXITY-ERRORS}
Rules that are `not-allowed' are `fixed up' during fixity
determination as follows.  An \key{error operator} is
...
any non-allowed non-prefix operator (as indicated by \OPSUP{--O}).
