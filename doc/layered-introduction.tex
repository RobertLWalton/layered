...
An \key{indented paragraph} has a paragraph indent and ends just
before the next line that has less indent, or at the
end of file.  An indented paragraph ends a logical line, and
begins with an indentation mark at the end of a physical line.
If the paragraph is
not empty, the paragraph indent is set to the indent of the next
non-blank, non-comment line following the line containing
the indentation mark.  The indented paragraph proper is a sequence of
zero or more logical lines and unindented paragraphs, all of which
are indented by the paragraph indent.  Any logical line or
unindented paragraph in this sequence may itself end with an indented
subparagraph .

An \key{unindented paragraph} ends with the next blank line.
An unindented paragraph is a sequence of logical lines that
does not contain any blank line.  It may include lines
which contain only a comment.  Only the last logical line of an
unindented paragraph may end with an indented subparagraph.
