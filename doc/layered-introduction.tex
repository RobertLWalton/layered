...
token that either has an \ttdkey{operator} attribute equal to
the first operator in the subexpression, or is reformatted by
a reformatter associated with this first operator.
