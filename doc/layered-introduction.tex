...
The operator parsing pass identifies operators, assignes fixity
...
The case $P=H+1$ is special: a {\em (H+1)-expression} is a sequence
of zero or more prefix operators followed by a single {\em (H+1)-expression}.
A {\em (H+2)-expression} is similarly just a {\em (H+3)-expression},
...
much higher precedence (H+1) than the infix operator.
...
A {\em parser-print-operator-command}
...
Operator reformatters are specified in \itemref{OPERATOR-REFORMATTERS}.
