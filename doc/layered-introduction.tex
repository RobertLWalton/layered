...
\begin{indpar}[0.1in]
\emkey{bracketed-subexpression}\label{BRACKETED-SUBEXPRESSION}
    \begin{tabular}[t]{@{}rll@{}}
    ::= & {\em untyped-bracketed-subexpression}
...
The {\em typed-prefix-separator} is \underline{not} inside a
{\em typed-bracketed-expression}\pagnote{TYPED-BRACKETED-SUBEXPRESSION}
(it may be inside a
{\em bracketed-expression}\pagnote{BRACKETED-SUBEXPRESSION}).
