...
The type can be omitted from the beginning if there are no attributes
...
the elements are always omitted.  Except in this last
case type and attribute labels
