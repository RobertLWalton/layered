...
4000    &     	& \ttkey{binary}
				& \TT{infix} & \ttkey{BUT NOT}
							  & logical and not & L
\\\cline{1-1}\cline{3-6}
4100	&       & \ttkey{uno}	& \TT{infix} & \ttkey{AND} & logical and &
\\\cline{5-6}
	& 	&		&	     & \ttkey{OR}  & logical or  &
\\\cline{1-1}\cline{3-6}
...
\\\cline{5-6}
	& 	&		&	     & \TT{>=}	& greater than or equal
	                                                               &
\\\cline{1-1}\cline{3-7}
6000	&       & \ttkey{duo}	& \TT{infix} & \TT{+}	& addition     & A
\\\cline{5-6}
	&	&		& 	     & \TT{-}	& subtraction  &
\\\cline{2-3}\cline{5-7}
	& code  & \ttkey{uno}	&            & \TT{|}	& binary or    & B
\\\cline{5-6}
	&	&		& 	     & \TT{\&}	& binary and   &
\\\cline{5-6}
	&	&		& 	     & \TT{\textasciicircum}
...
\\\cline{1-1}\cline{3-6}
6200	& math	& \ttkey{uno}	& \TT{infix} & \TT{*}   & multiplication &
\\\cline{1-1}\cline{3-6}
