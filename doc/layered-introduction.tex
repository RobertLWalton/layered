...
A `\ttmkey{singleton}{in lexical program} {\em kind}\,'
...
\end{indpar}
The {\tt singleton} {\em instruction-component} is useful for
...
// Before this lexical program is used the input should be
// preprocessed to replace trigraph sequences, eliminate
// carriage returns next to newlines, and eliminate backslash
// newline pairs.  Also any source file character that is not
// a basic character must be replaced by a universal character
// name (\uXXXX or \UXXXXXXXX).

"<ascii-letter>" = "a-z" | "A-Z";
"<digit>" = "0-9";
"<oct-digit>" = "0-7";
"<hex-digit>" = "0-9" | "a-f" | "A-F";
"<non-digit>" = "_" | "a-z" | "A-Z";  // I.e., in identifier.
...
// This master table scans at the beginning of lines
// for pp control directives.
//
begin pp group master atom table;
    mode master;
    "<horizontal-whitespace-char>" goto whitespace;
    "##" keep 0 goto non pp control master;
    "#" goto pp control sign;
    "<other>" goto non pp control master;
...
begin master atom table;
    ...
    "\\u<hex-digit><hex-digit><hex-digit><hex-digit>"
	    ...
	    "<letter>" else singleton non-letter UNICODE error;
    "\\U<hex-digit><hex-digit><hex-digit><hex-digit>"
       "<hex-digit><hex-digit><hex-digit><hex-digit>"
	    translate hex 2 0 goto identifier
	    "<letter>" else singleton non-letter UNICODE error;
    "{" singleton punctuation;
    "}" singleton punctuation;
end master atom table;
