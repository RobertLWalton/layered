...
\begin{figure*}[!p]
\emkey{name-symbol} ::= {\em word} $|$ {\em mark} $|$ {\em natural-number}
\\[0.5ex]
\emkey{non-special-name-symbol} ::=
    {\em name-symbol} that is \underline{not} treated specially by the parser
\\[0.5ex]
\emkey{name-component} ::= {\em non-special-name-symbol} $|$ {\em quoted-string}
\\[0.5ex]
\emkey{name} ::= {\em name-component} {\em name-component}\,$^\star$
\\[2ex]
\emkey{mark-symbol} ::= {\em mark}
\\[0.5ex]
