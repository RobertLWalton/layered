...
Lexemes that do not contain {\em space-characters}
may be separated by {\em white-space} lexemes:
\begin{indpar}
...
These are \skey{indent lexeme}s.  They have no characters,
but are used to communicate the indent of
...
A non-indent, non-line-break {\em white-space}, such as occurs
in the middle of text or code outside comments, is a lexeme but is
usually discarded by the parser.
...
begin begin line master table;
   ...
   "<horizontal><repeat>//"
                keep 1
                output indent before comment
                goto horizontal space
   "<horizontal><repeat>/"
                keep 1
                output indent
                goto horizontal space
   "<horizontal><repeat><non-/-graphic>"
                keep 1
                output indent
                goto horizontal space
   "<horizontal><repeat>"
...
begin within line master table;
   ...
   "<non-ASCII-digit>" output numeric
                       goto finish middle;
