...
The standard scanner also tries to promote `distrubuted modularity',
...
For example, the lexeme \TT{9.35} may have type `\TT{number}'
...
\pagref{LEXEME-PROGRAM-LEXEMES}.  Lexemes may be separated by
{\em white-space}:
\begin{indpar}
...
\emkey{horizontal-space-character} ::=
    {\em single-space-character} $|$ {\em horizontal-tab-character}
\\[0.3ex]
\emkey{vertical-space} ::= {\em line-end}\PLUS{}
\\[0.3ex]
\emkey{line-end} ::= {\em line-end-modifier}\STAR{}
		     {\em line-feed-character}~
		     {\em line-end-modifier}\STAR{}
\\[0.3ex]
\emkey{line-end-modifier}
	\begin{tabular}[t]{@{}rl@{}}
	::= & {\em form-feed-character} \\
	$|$ & {\em vertical-tab-character} \\
	$|$ & {\em carriage-return-character}
	\end{tabular}
\end{indpar}

The line number and beginning column of each lexeme is recorded
...
Lines are ended by {\em line-ends}; the
{\em line-end-modifier} characters are ignored when computing
line numbers.  Note that {\em line-end-modifier} characters must
be within a {\em line-end}, else they are ignored and a warning
message issued.  Other control characters are ignored and a
...
\\[0.3ex]
\emkey{separator} ::= {\em separator-character} except \TT{|} $|$ \TT{|}\PLUS{}
\\[1ex]
...
\emkey{mark-character}
	...
	::= & \TT{+}%
        ...
        $|$ & \TT{:} \begin{tabular}[t]{@{}l@{}}
	             not surrounded by {\em digits} \\
	             and either preceded by a \TT{:} \\
	             or followed by a {\em mark-character} \\
		     \end{tabular} \\
...
\emkey{separator-character}
	...
	$|$ & \TT{'} not followed by a letter \\
        $|$ & \TT{:} \begin{tabular}[t]{@{}l@{}}
	             not surrounded by {\em digits}, \\
	             not preceded by a \TT{:}, \\
	             and not followed by a {\em mark-character} \\
		     \end{tabular} \\
	\end{tabular}
\\[0.3ex]
...
\emkey{special-character-representative} ::=
    \TT{<} {\em upper-case-letter}
           \{ {\em upper-case-letter} $|$ {\em digit} \}\STAR{} \TT{>}
\\[0.3ex]
