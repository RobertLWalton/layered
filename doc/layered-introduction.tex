...
If a prefix with this type is a paragraph or line header, the `end-at'
options (see \pagref{PARSING-END-AT-OPTIONS-1}) in this parameter are
used to determine when a logical line ends.
See \itemref{PARAGRAPH-AND-LINE-HEADERS}.
...
or lines that had not explicit header prefix of their own).
...
These headers can be in one of three forms:

\begin{center}
\begin{tabular}{l}
bracketed headers, which are typed paragraph separators
