...
\\
    ...
    ::= & \TT{parser}%
	  ...
	  {}[ \TT{with end at options} {\em end-at-options} ] \\
	  \end{tabular} \\
...
If the prefix group is `\TT{paragraph}' or `\TT{line}', this parameter
may be used to set the lexical master, which determines how lexemes
are scanned, at the beginning of a logical
line.  See \itemref{PARAGRAPH-AND-LINE-HEADERS}.
\\[2ex]
\hspace*{-0.2in}\ttmkey{at end options}{in prefix definition}\\
If the prefix group is `\TT{paragraph}' or `\TT{line}', this parameter
may be used to set the at-end options, which determine when a logical
line ends, at the beginning of a logical
line.  See \itemref{PARAGRAPH-AND-LINE-HEADERS}.
