...
\hspace*{-0.2in}\TT{paragraph line lexical master}
    ...
    The paragraph line variables of an indented paragraph are set from
    the \TT{define inden\-ta\-tion mark} parser command
    (\pagref{PARSER-INDENTATION-MARK-COMMAND}), and with the exception
    of the paragraph implied header, are not changed while parsing the indented
    paragraph.
