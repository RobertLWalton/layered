...
\emkey{typed-opening} ::=
   ...
   {\em key} ~~~~~ [e.g., `\TT{\{}'] \\
    ...
    \end{tabular}
\\[0.5ex]
\emkey{typed-middle} ::= {\em key}
    ~~~~~ [e.g., `\TT{|}']
\\[0.5ex]
\emkey{typed-closing} ::= {\em key}
    ~~~~~ [e.g., `\TT{\}}']
\\[0.5ex]
\emkey{typed-attribute-begin} ::= {\em key}
    ~~~~~ [e.g., `\TT{:}']
\\[0.5ex]
\emkey{typed-attribute-separator} ::= {\em key}
    ~~~~~ [e.g., `\TT{,}']
\\[0.5ex]
\emkey{typed-attribute-equal} ::= {\em key}
    ~~~~~ [e.g., `\TT{=}']
\\[0.5ex]
\emkey{typed-attribute-negator} ::= {\em key}
    ~~~~~ [e.g., `\TT{no}']
\\[0.5ex]
\emkey{typed-attribute-flags-opening} ::= {\em key}
    ~~~~~ [e.g., `\TT{[}']
\\[0.5ex]
\emkey{typed-attribute-flags-separator} ::= {\em key}
    ~~~~~ [e.g., `\TT{,}']
\\[0.5ex]
\emkey{typed-attribute-flags-closing} ::= {\em key}
    ~~~~~ [e.g., `\TT{]}']
\\[0.5ex]
\emkey{attribute-multivalue-opening} ::= {\em key}
    ~~~~~ [e.g., `\TT{\{*}']
\\[0.5ex]
\emkey{attribute-multivalue-separator} ::= {\em key}
    ~~~~~ [e.g., `\TT{,}']
\\[0.5ex]
\emkey{attribute-multivalue-closing} ::= {\em key}
    ~~~~~ [e.g., `\TT{*\}}']
\\[0.5ex]
