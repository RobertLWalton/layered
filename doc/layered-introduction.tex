...
which may be `\TT{none}', and a \key{return stack}
...
\begin{center}
\TT{"<{}<hex-digit><hex-digit><hex-digit><repeat>{}>"}
\end{center}
...
`\TT{unrecognized escape sequence}'.  Otherwise this atom will be processed
