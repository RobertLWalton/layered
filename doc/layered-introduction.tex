...
selectors, options, and lexical masters.
If in addition the prefix definition has an implied subprefix
that itself has a prefix definition selected by the modified
selectors which has the `\TT{line}' group, this implied subprefix
...
now has the `\TT{sticky}' option flag, the \TT{para\-graph implied
header} line variable is set to a copy of the explicit paragraph header.

\item Otherwise the \TT{paragraph implied header} line variable
