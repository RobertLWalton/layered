...
The following are examples of (untyped)
\ikey{bracketed subexpressions}{bracketed subexpressions!untyped},
...
begins with an {\em indentation-mark} which must be at the end of
