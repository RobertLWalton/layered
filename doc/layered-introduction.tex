...
\newsavebox{\LACCENTBOX}
\begin{lrbox}{\LACCENTBOX}
{\tt \`{}}
\end{lrbox}
\newcommand{\LACCENT}{\usebox{\LACCENTBOX}}

\newsavebox{\RACCENTBOX}
\begin{lrbox}{\RACCENTBOX}
{\tt \'{}}
\end{lrbox}
\newcommand{\RACCENT}{\usebox{\RACCENTBOX}}
...
and {\em named-operators} (as per \secref{NAMED-OPERATORS})
...
\\[2ex]
0000	& \ttkey{declare}	& \tt nofix	& \ttnbkey{<--}	& define \\
	&			& \tt afix	& \ttkey{\{ ... \}} & block \\
...
4000 	& \ttkey{infix and}	& \tt infix	& \ttnbkey{==}	& equal \\
	&			&		& \ttnbkey{/=}  & not equal \\
	&			&		& \ttnbkey{!=}	& ditto \\
	&		      	&		& \ttnbkey{<}	& less than \\
	&			&		& \ttnbkey{<=}	& less than or
