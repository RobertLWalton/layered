...
\tt ~~~~~~~with infix and reformatter ( "AND" ) \\
\tt define operator "<=" [code, math] infix & {\tt + code} or {\tt + math} \\
\tt ~~~~~~~with precedence 4000 \\
\tt ~~~~~~~with infix and reformatter ( "AND" ) \\
\tt define operator ">=" [code, math] infix & {\tt + code} or {\tt + math} \\
...
\tt ~~~~~~~with sum reformatter ( "+", "-" ) \\
\tt define operator "-" [code, math] infix & {\tt + code} or {\tt + math} \\
\tt ~~~~~~~with precedence 5000 \\
\tt ~~~~~~~with sum reformatter ( "+", "-" ) \\
\tt define operator "/" [code, math] infix & {\tt + code} or {\tt + math} \\
\tt ~~~~~~~with precedence 5100 \\
\tt ~~~~~~~with binary reformatter \\
\tt define operator "*" [code, math] infix & {\tt + code} or {\tt + math} \\
...
\tt ~~~~~~~with infix reformatter
\\[1ex]
\tt define operator "\~" [code] prefix & {\tt + code} \\
\tt ~~~~~~~with precedence 999999 \\
\tt ~~~~~~~with unary reformatter \\
\end{tabular}
\end{center}
