...
begin master atom table;
   ...
   "<word-char>" goto word;
   "'<letter>" goto word;
    "\\/" translate escaped character representative
          require "<letter>" goto word
          else goto bad escape sequence;
...
begin escaped character representative translation table
    ...
    "\\/0<hex-digit><hex-digit><hex-digit><hex-digit>"
        "<hex-digit><hex-digit><hex-digit><hex-digit>/"
              translate hex 2 1
    fail
end escaped character representative translation table


begin bad escape sequence atom table;
    "<line-break>" goto master;
    "/" goto master;
    "<other>" accept;
    goto master;
end bad escape sequence atom table;

begin bad end of line atom table;
    mode master;
    output bad end of line
           goto master;
end bad end of line atom table;


begin bad end of file; atom table
    mode master;
    output bad end of file
           goto master;
end bad end of file atom table;
...
begin pp include master table;
    ...
    "<opsep-char-except-<>" translate operator
    			    output operator
          else output unrecognized character
...
begin normal master table;
    ...
    "<opsep-char>" translate operator output operator
                   else output unrecognized character
...
begin identifier lexeme table;
    "<non-digit>" accept;
    "\\/" translate escaped letter accept
          else translate universal character
	       error unrecognized universal character
          else keep 0 return
    goto normal;
...
begin character literal lexeme table;
    ...
    "\\/" translate escaped character representation
          else error bad escape character;
    "<other>" accept;
...
//
begin escaped character representation translation table;
    "\\/n" translate "\lf/";
    "\\/t" translate "\ht/";
    "\\/v" translate "\vt/";
    "\\/b" translate "\bs/";
    ...
    "\\/U<hex-digit><hex-digit><hex-digit><hex-digit>"
        ...
        translate-hex 2 0;
    fail;
end escaped character representation translation table;
