...
subexpression.  Which passes are run is determined by the
...
and then reinstalled.  The {\em parser-pass-name} and
...
The {\tt parser print pass} statement prints the parsing pass stack.
...
The pass is responsible for calling the next pass on the parser
pass stack, and may edit the sublist before and/or after calling
this next pass.

The bracketed subexpression pass is called for each top level input line
and replaces that line with a MIN object token.
