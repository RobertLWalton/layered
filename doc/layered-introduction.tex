...
\begin{indpar}
Output by the \TT{PARAGRAPH\_\EOL CHECK} lexical master
...
\begin{indpar}
Output by the \TT{ROW\_\EOL CHECK} lexical master when the next
input character is `\TT{|}', or
when the next 5 input characters are either `\TT{-{}-{}-{}-{}-}' or
`\TT{=====}'.
...
\\\hline
\\[0.5ex]
\TT{DATA\_CHECK}	& \TT{@}		& \TT{DATA} \\
			& \TT{!@}		& \TT{RAW\_DATA} 
\\[2ex]
\TT{PARAGRAPH\_CHECK}	& \TT{@}		& \TT{DATA} \\
			& \TT{!@}		& \TT{RAW\_DATA} \\
			& \TT{-{}-{}-{}-{}-}	& \TT{TABLE} \\
			& \TT{=====}		& \TT{TABLE}
\\[2ex]
\TT{ROW\_CHECK}		& \TT{|}		& \TT{ROW} \\
			& \TT{-{}-{}-{}-{}-}	& \TT{ROW} \\
			& \TT{=====}		& \TT{ROW}
\\[2ex]
