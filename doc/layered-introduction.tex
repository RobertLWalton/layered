...
\multicolumn{2}{c}
{\bf Standard `\ttkey{conditional operators}'\label{STANDARD-CONTROL-OPERATORS}
     Component} \\
\multicolumn{2}{c}
...
\tt ~~~~~~~with precedence 0 \\
\tt ~~~~~~~with conditional reformatter ( ":", has condition ) \\
...
\tt ~~~~~~~with precedence 0 \\
\tt ~~~~~~~with conditional reformatter ( ":" ) \\
\\[1ex]
