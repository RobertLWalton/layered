...
\hspace*{-0.2in}\ttmkey{paragraph lexical master}{line variable}\\
    ...
    The lexical master is also reset to this value just after
    a prefix lexeme that is replaced by a paragraph header.
\\[1ex]
\hspace*{-0.2in}\ttmkey{line lexical master}{line variable}\\
    ...
    The lexical master is also reset to this value just after
    a prefix lexeme that is replaced by a line header.
\end{indpar}
