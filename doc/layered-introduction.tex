...
\item If the logical line is in paragraph beginning position and
the instruction variable value contains the paragraph reset command,
reset all the line variables to their values at the
beginning of the indented paragraph.
...
The general syntax of {\em parser-header-commands} is:
