...
called `\skey{comment line}s'.  Empty logical lines and comment lines
are discarded unless they end with a line separator.
...
\item The first indent token after any line-break.
