...
\hspace*{-0.2in}\ttdmkey{terminator}{subexpression attribute}\\
    ...
    or & the {\em indentation-separator-name} used to end a subexpression \\
...
any sequence of marks, separators, words, or numbers.
...
can terminate the subexpression.  However, subsubexpressions can appear
in the normal way within the `{\tt full line}' subexpression.
...
is recognized.  Note that {\em closing-bracket-name}
