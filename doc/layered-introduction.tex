...
Details on indented paragraphs is given
...
table index, which when not \TT{0} specifies a special
lexical scan performed at the beginning of each logical line.
This special scan can introduce paragraph or line headers based on
the first characters in the logical line (see \itemref{MAPPED-LEXEMES}).
