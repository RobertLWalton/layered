...
its `\TT{value}' is a MIN object that encodes its logical line.
...
the special value `\ttsvkey{IN\-DEN\-TED\_\EOL PARAGRAPH}' being the
\TT{.term\-i\-na\-tor}.  The elements of an indented paragraph are
logical lines, whose \TT{.initiator}
is the special value `\ttsvkey{LOGICAL\_LINE}' and whose \TT{.term\-i\-na\-tor}
...
{\em typed-bracketed-sub\-ex\-pres\-sions}, and paragraphs and logical
