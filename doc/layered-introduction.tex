...
with flags or any single attribute values.  Also the {\em prefix}
...
\underline{not} cause garbage collection errors, but will generate
a parser error message.  Dangling references will print as
preallocated stubs with their ID number which can be used for finding
