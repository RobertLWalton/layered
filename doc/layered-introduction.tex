...
\begin{center}
\TT{\{data} {\em prefix-attributes}\QMARK{} \TT{|}
...
except \TT{.position}, and if the only element is an object,
then this only element becomes the value assigned to {\em ID}
in place of the list containing just this element.  E.g.,
\begin{center}
\TT{@5 = ( a b c )}
\end{center}
sets \TT{@5} to \TT{(a b c)} and \underline{not} \TT{\{|(a b c)|\}}.
However
\TT{@5 = Bill}
sets \TT{@5} to \TT{\{|Bill|\}} and \underline{not} \TT{Bill}.
