...
parsing end at options	& 6 bits	& \pagref{OPTION-NAMES} \\
parsing enable options	& 1 bits	& \pagref{OPTION-NAMES} \\
parsing prefix options	& 3 bits	& \pagref{OPTION-NAMES} \\
...
\begin{center}
    ...
    \TT{~~~~}[ \TT{with parsing selectors} {\em top-level-selectors} ] \\
...
\item If the logical line is the first of a file, or the first of an
