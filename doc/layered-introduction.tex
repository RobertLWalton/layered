...
The `\ttkey{brackets}'\label{STANDARD-BRACKETS-1} standard component executes
...
The `\ttkey{indentation marks}'\label{STANDARD-INDENTATION-MARKS}
standard component executes the following parser commands:
\begin{center}
\begin{tabular}{l@{\hspace*{0.5in}}l}
\multicolumn{2}{c}{For \ttkey{indentation marks} Standard Parser Component}
\\[1ex]
Parser Command				& \shortstack{
                                          Required\\Qualifiers}
\\\hline
...
The `\ttkey{brackets}'\label{STANDARD-BRACKETS-2} standard component executes
the following parser command:
\begin{center}
\begin{tabular}{l}
\multicolumn{1}{c}{This Command Requires at Least One of
                   {\tt + code, + text, + math}} \\
\multicolumn{1}{c}{Missing Selector Qualifiers are Deleted from the Command}
\\[1ex]
