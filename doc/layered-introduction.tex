...
or the 6-character sequence \verb|\u000a| which matches the atom pattern
\begin{center}
...
\tt positions	& The positions of the first and last character of the
	          token in the input tex.  It is possible to recover
		  from a position the column number within a line
		  and a line ident, where two line idents are equal
		  if and only if the file lines the denote are the same.
