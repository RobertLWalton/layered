...
\hspace*{-0.2in}\ttmkey{end at paragraph break}{parser option} \\
    ...
    paragraph indent also end logical lines is controlled by other
    options.

    If this option is not present, blank lines have not affect
    on parsed input.

\hspace*{-0.2in}\ttmkey{end at le indent}{parser option} \\
    This parser option causes the beginning of a line with indent less than
    \underline{or equal to} the paragraph indent to end a logical line.
    This means that logical lines can be continued by input lines
    with indent greater than the paragraph indent, assuming other
    options permit.
...
\hspace*{-0.2in}\ttmkey{end at lt indent}{parser option} \\
    This parser option causes the beginning of a line with indent less than
    the paragraph indent to end a logical line.
    This means that logical lines can be continued by input lines
    with indent \underline{equal to} or greater
    than the paragraph indent, assuming other
    options permit.
