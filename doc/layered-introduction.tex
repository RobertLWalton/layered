...
of context variables called the \skey{line beginning variable}s.

When a bracketed or lexical paragraph header is recognized as
having a selected header table entry, the line beginning
...
having a selected header table entry, some of the line beginning
variables are reset according to values in that table entry.

We next list the \skey{line beginning variable}s, and after that
spell out the line beginning algorithm in detail.

\begin{indpar}[0.4in]

\hspace*{-0.2in}\ttmkey{paragraph lexical index}{line beginning variable}\\
\hspace*{-0.2in}\ttmkey{line lexical index}{line beginning variable}\\
    ...
    beginning position, the paragraph lexical index is used.  Otherwise
    the line lexical index is used.
\\[2ex]
\hspace*{-0.2in}\ttmkey{paragraph header}{line beginning variable}\\
...
\\[1ex]
\hspace*{-0.2in}\ttmkey{line header}{line beginning variable}\\
    If this value is not missing
...
\\[2ex]
\hspace*{-0.2in}\ttmkey{header selectors}{line beginning variable}\\
...
\\[1ex]
\hspace*{-0.2in}\ttmkey{header options}{line beginning variable}\\
...
\\[2ex]
\hspace*{-0.2in}\ttmkey{line selectors}{line beginning variable}\\
    ...
    selectors.
\\[1ex]
\hspace*{-0.2in}\ttmkey{line options}{line beginning variable}\\
    ...
    options.
\\[1ex]
\hspace*{-0.2in}\ttmkey{instruction}{line beginning variable}\\
...
The line beginning variables are initialized according to the
indentation mark that introduced the indented paragraph.  For
top level the paragraph lexical index is the parser's default
lexical index, the line lexical index is \TT{0}, the headers are missing,
...
In addition to the line beginning variables, there are selectors
...
reset all the line beginning variables to their values at the
beginning of the indented paragraph.

\item Set the lexical scanner master index to the paragraph lexical
index if the logical line is in paragraph beginning position,
or to the line lexical index otherwise.
...
line beginning variables according to values in the table entry
...
Else reset all the
line beginning variables from values in this entry (see details
...
line beginning variable to a copy of the value of the token,
reset the line selectors and line options
line beginning variables from the values in the
