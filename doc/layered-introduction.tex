...
\emkey{function-prototype} \begin{tabular}[t]{rl}
		      ::= & {\em prototype-arguments}\STAR{}
			    {\em prototype-term}\PLUS{} \\
		      $|$ & {\em prototype-arguments}
		            {\em prototype-arguments}\PLUS{}
		      \end{tabular}
\\[0.5ex]
\emkey{prototype-term} ::= {\em prototype-term-name}
                           {\em prototype-argument-list}\STAR{}
\\[0.5ex]
\emkey{prototype-term-name} ::= {\em name-lexeme}\PLUS{}
\\[0.5ex]
\emkey{name-lexeme} ::= see \pagref{NAME-LEXEME}
\\[0.5ex]
\emkey{prototype-arguments} ::= {\em subexpression}  TBD
\\[0.5ex]
