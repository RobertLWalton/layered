...
of the parser symbol tables.  Entries in this table are managed
by parser prefix commands.
...
\hspace*{-0.2in}\ttmkey{implied subheader}{in prefix definition}\\
Used only for prefixes that are \TT{.types} of implied paragraph 
or implied line header lexemes.  For these prefixes, used
