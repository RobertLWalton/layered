...
\\\cline{2-5}
	& code  & (none)	& \TT{postfix } & \ttkey{:} indentation
	                                                   &           & \\
	&	&		& \TT{line}  & ~~~mark     &           &
\\\cline{4-4}\cline{6-6}
	&       &       	& \TT{afix } &             & assignment & \\
...
\hspace*{2em} {\em operand} {\em op} {\em operand}

or

\hspace*{2em}\begin{tabular}{l}
             {\em operand} {\em op} {\em operand}\QMARK{} {\em delimiter} \\
	     ~~~~~{\em statement}\STAR{}
	     \end{tabular}

The {\em delimiter} is typically \TT{:}.  The second {\em operand}
is a typically list of {\em expressions}.  In the first form these
are typically evaluated for their values, and in the second form they are
typically iteration operator {\em expressions}.
