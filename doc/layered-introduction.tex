...
A logical line in an unindented paragraph can contain an
indented paragraph.  In this case, if the contained indented
paragraph contains a blank line, it must be at the end of
its containing unindented paragraph.
...
contains a single
logical line which is continued across physical lines until
the next blank line (or end of file or end of containing
indented paragraph).
