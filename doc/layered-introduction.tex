...
(prefix, infix, postfix, and nofix) to the operators, and then
uses the following syntax to identify subexpressions:
...
where N is any, L is the lowest, and H is the highest precedence allowed \\
an infix or nofix operator
\end{tabular}
\end{indpar}
