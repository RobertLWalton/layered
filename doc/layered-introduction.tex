...
\emkey{symbol} & ::= & {\em word} $|$ {\em mark} $|$ {\em separator}
	         $|$ {\em natural-number}
\\[0.3ex]
\emkey{word} & ::= & {\em word-prefix-character}\STAR{} \\
             &     & {\em word-character} {\em word-character}\,\STAR{}
\\[0.3ex]
...
\\[2ex]
\emkey{word-character} & ::= & {\em letter} $|$ \TT{'} followed by a letter \\
...
\emkey{upper-case-letter} & ::= &
			    ...
			    $|$\TT{Z}
\\[0.3ex]
\emkey{word-prefix-character} & ::= & \TT{.} followed by a
                                      \TT{.} or {\em letter}
\\[0.3ex]
...
\emkey{character-representative}
    ...
    & $|$ & \TT{<}{\em character-code}%
	    \{\TT{-}{\em character-code}\}\QMARK{}\TT{>} \\
\emkey{character-code} & ::= & {\em character-code-character}\PLUS{} \\
\emkey{character-code-character} & ::= & {\em upper-case-letter} $|$
                                         {\em digit} \\
\emkey{graphic-character} & ::= &
    {\em non-whitespace-non-control-character} \\
\emkey{angle-brackets} & ::= & \TT{<} $|$ \TT{>}
\\[1.0ex]
...
\\[1ex]
\emkey{remove-clause} & ::= & \TT{remove} {\em lexical-table-name} \\
...
\\[1ex]
\emkey{cpat-name} & ::= &
	\TT{<}{\em letter}\PLUS{}\{\TT{-}{\em letter}\PLUS{}\}\STAR{}\TT{>} \\
	\multicolumn{2}{r}{but not} &
	{\em character-representive} \\
\\[1ex]
\emkey{cpat-expression} & ::= &
	{\em cpat-term}
	\{ \TT{|} {\em cpat-term} \}\STAR{} \\
       & $|$ &
	{\em cpat-term}
	\{ \TT{\&} {\em cpat-term} \}\STAR{}
\\[1ex]
\emkey{cpat-term} & ::= & {\em cpat-factor} $|$ \TT{\textasciitilde} {\em cpat-factor}
\\[1ex]
\emkey{cpat-factor} & ::= & \TT{"}{\em quotable-character}\TT{"} \\
		    & $|$ & \TT{"}{\em quotable-character}\TT{-}%
		                   {\em quotable-character}\TT{"} \\
		    & $|$ & \TT{"}{\em cpat-name}\TT{"} \\
		    & $|$ & \TT{(} {\em cpat-expression}
		                \TT{)}
\\[1ex]
...
\\[1ex]
\emkey{atom-factor} & ::= &
	{\em atom-primary} $|$ {\em atom-primary}\TT{<repeat>}
\\[1ex]
\emkey{atom-primary} & ::= & {\em quotable-character} $|$
                             {\em cpat-name} except \TT{<repeat>}
\\[1ex]
...
\TT{"0"} and \TT{"+"}.  The next simplest is two {\em quotable-characters}
