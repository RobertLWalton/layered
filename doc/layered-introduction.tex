...
as the {\em prefix-n}'s {\em implied-prefix} (and that is not
missing), then a copy of
the {\em implied-prefix} is prepended to the {\em prefix-(n+1)-list}.

[The implementation is to prepend the {\em implied-prefix} always, and
