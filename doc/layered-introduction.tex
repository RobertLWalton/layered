...
\hspace*{-0.2in}\ttmkey{paragraph selectors}{line beginning variable}\\
    ...
    of a logical line that is the first logical line of an indented
    paragraph or is just after a blank line that follows a logical line.
\\[1ex]
...
\hspace*{-0.2in}\ttmkey{default paragraph header}{line beginning variable}\\
    ...
    beginning of a logical line that is the first of its indented
    paragraph or is after a blank line that follows a logical line
    in the paragraph, then a prefix separator token whose value is a
...
\hspace*{-0.2in}\ttmkey{line selectors}{line beginning variable}\\
    The parsing selectors are set to this value at the beginning
    of a logical line that is not the first logical line of an indented
    paragraph and is not just after a blank line that follows a logical line.
\\[1ex]
...
\hspace*{-0.2in}\ttmkey{default line header}{line beginning variable}\\
    If not \TT{MISSING} and no explicit paragraph header is found at the
    beginning of a logical line that is not the first of its indented
    paragraph and is not after a blank line that follows a logical line
    in the paragraph, then a prefix separator token whose value is a
