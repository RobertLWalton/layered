...
expression-begin & infix & not-allowed \\
expression-begin & postfix & not-allowed \\
...
non-operator & prefix & not-allowed \\
...
prefix & infix & not-allowed \\
prefix & postfix & not-allowed \\
prefix & nofix & not-allowed \\
prefix & expression-end & not-allowed \\
\hline
infix & non-operator & infix non-operator \\
infix & prefix & infix prefix \\
infix & infix & not-allowed \\
infix & postfix & not-allowed \\
infix & nofix\SUP{H} & infix nofix \\
infix & nofix\SUP{--H} & not-allowed \\
infix & expression-end & not-allowed \\
\hline
postfix & non-operator & not-allowed \\
postfix & prefix & not-allowed \\
...
nofix\SUP{--H} & infix & not-allowed \\
nofix & postfix & not-allowed \\
...
\hline
expression-begin & infix-or-postfix & not-allowed \\
non-operator & infix-or-postfix & unresolved \\
prefix & infix-or-postfix & not-allowed \\
infix & infix-or-postfix & not-allowed \\
postfix & infix-or-postfix & unresolved \\
nofix\SUP{H} & infix-or-postfix & nofix infix \\
nofix\SUP{--H} & infix-or-postfix & not-allowed \\
infix-or-prefix & infix-or-postfix & not-allowed \\
...
infix-or-prefix & infix & not-allowed \\
infix-or-prefix & postfix & not-allowed \\
infix-or-prefix & nofix\SUP{H} & infix nofix \\
infix-or-prefix & nofix\SUP{--H} & not-allowed \\
infix-or-prefix & expression-end & not-allowed \\
\hline
...
\begin{tabular}{rl}
\SUP{H}   & means operator has higher precedence than \\
          & the precedence of the preceding operator\\[1ex]
\SUP{--H} & means operator has precedence lower than or equal to \\
          & the precedence of the preceeding operator\\[1ex]
\SUP{A}  & means operator is afix\\[1ex]
\SUP{--A} & means operator is \underline{not} afix
\end{tabular}
\\
