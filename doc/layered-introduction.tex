...
A `\key{mapped-lexeme}'
is a special kind of lexeme that has its own special lexeme type
which can be mapped to change the token type and value
by the `\key{mapped lexeme symbol table}'.
