...
\\[0.5ex]
\emkey{call-term-name} ::= {\em name-lexeme}\PLUS{}
\\[0.5ex]
...
\emkey{prototype-term} ::= {\em prototype-term-name}
                           {\em prototype-argument-list}\STAR{}
\\[0.5ex]
\emkey{prototype-term-name} ::= \begin{tabular}[t]{@{}l}
                                {\em name-lexeme}\PLUS{} excluding
				(un-quoted) {\em marks} and {\em separators} \\
				and not beginning with a {\em natural}
				\end{tabular}
\\[0.5ex]
\emkey{name-lexeme} ::= see \pagref{NAME-LEXEME}
\\[0.5ex]
...
\item If a prototype begins with a {\em prototype-argument-list},
that list must begin with an {\em argu\-ment-declaration} that
has no {\em default-value}, and the next thing in the prototype must
be either another {\em prototype-argument-list} beginning with an
{\em argument-declaration} that has no {\em default-value}, or
a {\em prototype-term-name}.
\item
