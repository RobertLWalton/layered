...
\begin{indpar}[0.5em]
The subexpression must be a MIN value that could be represented by
...
The MIN \TT{\{data \ldots{}|\ldots{}|\}} object generated by the input
logical line is itself deleted from
the input and can have no effect other than setting the {\em ID} to the
desired value.
...
the reformatter does nothing
and the object is \underline{not} deleted.  On the other hand,
