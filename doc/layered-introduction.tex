...
set for the indented paragraph (e.g., by the intentation
...
the \TT{selectors} line variable.
It must exist and have `\TT{paragraph}' group,
...
value of \TT{lexical master} in the paragraph prefix definition if
the latter is not \TT{MISSING}.
...
prefix definition \TT{parsing selectors} and \TT{parsing options}.
The \TT{lexical master} line variable is reset to the
value of \TT{lexical master} in the line prefix definition if
the latter is not \TT{MISSING}.
