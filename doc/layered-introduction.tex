...
options so that only a blank line or the beginning of a
line indented less than the current indent terminate a logical line,
then:
\begin{indpar}\begin{verbatim}
This logical line contains:
...
is parsed to the logical line containing an indented paragraph
...
Note that a closing bracket or prefix separator can \underline{not}
force the end of a logical line.
