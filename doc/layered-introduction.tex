...
\emkey{function-call} \begin{tabular}[t]{rl}
		      ::= & {\em argument-list}\STAR{}
			    {\em function-term}\PLUS{} \\
		      $|$ & {\em argument-list} {\em argument-list}\PLUS{}
		      \end{tabular}
\\[0.5ex]
\emkey{function-term} ::= {\em function-term-name} {\em argument-list}\STAR{}
\\[0.5ex]
\emkey{variable-name} ::= {\em name-lexeme}\PLUS{}
\\[0.5ex]
\emkey{function-term-name} ::= {\em name-lexeme}\PLUS{}
\\[0.5ex]
\emkey{name-lexeme} \begin{tabular}[t]{rl}
		    ::= & {\em number} $|$
			  {\em natural} $|$
			  {\em numeric-word} \\
		    $|$ & {\em word} $|$
...
\item
A compiler may constrain the types of lexemes in a {\em function-term-name}.
