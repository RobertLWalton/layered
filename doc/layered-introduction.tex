...
level language would add and extensive library to this low level
language and integrate parts of this library into the syntax.
The high level language would add an integrated interpretive language
integrated with the middle level language.

However there are other agendas for the layered langauges.  One
is to build an interpretive language that integrates the tools
a non-professional programmer might used in dayly life.  This
means integrating a classic programming language with a text
processing langauge, a spreadsheet-like language, etc.
...
is a C/C++ constant representing an IEEE double precision number.
Conversely, a C/C++ constant representing an IEEE double precision number
and not ending in a {\em decimal-point}
