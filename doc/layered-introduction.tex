...
\emkey{indentation-mark-name} ::= {\em mark-name}
                              $|$ {\em gluing-indicator} {\em gluing-mark-name}
\\[2ex]
\emkey{gluing-mark-indicator} ::= \ttmkey{*}{gluing mark}
\\[0.5ex]
\emkey{gluing-mark-name} ::= {\em mark} $|$ {\em quoted-string}
\\[2ex]
\emkey{indentation-separator-name} ::= {\em mark} $|$ {\em separator }
				   $|$ {\em quoted-string}
\\[2ex]
...
{\tt define indentation mark} parsing definition, and may have
...
paragraph lines, as long as it is outside (named or unnamed)
bracketed subexpressions in the paragraph.
