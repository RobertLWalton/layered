...
and in appropriate contexts bracketed subexpressions whose \TT{.initiators} are
{\em typed-attribute-flags/multivalue-initiators}.

\item Additional passes (e.g., the operator parsing pass), which are applied to
...
{\em untyped-bracketed-subexpressions}
and {\em indented-para\-graphs} that appear \underline{inside}
...
Internal
    & {\em typed-middle} & \TT{always} \\
Typed
    & {\em typed-attribute-begin} & \TT{always} \\
Subexpression
    & {\em typed-attribute-equal} & \TT{always} \\
Reformatter
    & {\em typed-attribute-separator} & \TT{always} \\
...
parser define bracket "{*" ... "*}" [data]
       with parsing options [- end at line separator]
       with parsing selectors [data]
parser define operator "," [code, math, data] nofix
