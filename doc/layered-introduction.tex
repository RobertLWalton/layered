...
\hspace*{-0.2in}\ttmkey{paragraph lexical index}{line beginning variable}\\
    ...
    See details below.
\\[1ex]
\hspace*{-0.2in}\ttmkey{default paragraph header}{line beginning variable}\\
    ...
    copy of this default paragraph header is inserted
...
\hspace*{-0.2in}\ttmkey{line lexical index}{line beginning variable}\\
    ...
    See details below.
\\[1ex]
\hspace*{-0.2in}\ttmkey{default line header}{line beginning variable}\\
    If not \TT{MISSING} and no explicit paragraph header is found at the
    ...
    copy of this default line header is inserted
    at the beginning of the logical line.
...
position, or are line header otherwise.

If the result of this lookup is an accepted entry, execute the
instructions specified by this entry (see below).
...
\hspace*{-0.2in}\ttmkey{default header}{prefix header type option} \\
    If a prefix header type has this option flag, then any
    prefix separator with the type that begins a logical line
    becomes the default prefix header.
