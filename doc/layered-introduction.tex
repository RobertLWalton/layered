...
[The implementation is to prepend the implied prefix always, and
then if it is later discovered to head a {\em prefix-(n+1)-list} with
zero elements, delete it.]
