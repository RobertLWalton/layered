...
Note: The C/C++ numbers convertable to IEEE double precision
are just the {\em numeric-word}, {\em natural}, and {\em number} lexemes,
except the lexemes cannot end in a {\em decimal-point} and the
{\em numeric-words} are case sensitive.
...
\begin{tabular}{p{1in}p{4.5in}}
		& Standardly, the lexeme characters of a
		  natural or number lexeme are converted to
...
\\[1ex]  
\begin{tabular}{p{1in}p{4.5in}}
		& Note that natural and number lexemes have MIN number
		  ...
		  \TT{"1e1"}, are natural lexemes and not number lexemes.
...
\\[1ex]
		& A \key{symbol} is a MIN string equal to the
		  ...
		  string of a natural lexeme.  Quoted string, numeric,
...
mark, separator, or natural, can match label symbols.
These symbols
