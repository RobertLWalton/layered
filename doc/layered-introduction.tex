...
Section~\itemref{UNINDENTED-PARAGRAPHS}.
...
\\[0.5ex]
\emkey{token-type} ::= \TT{BRACKETED} $|$ \TT{BRACKATABLE}
...
and whose elements arrise from the rest of the logical line.
