...
Explicit paragraph headers make such changes if they have
the `\TT{sticky}' or `\TT{continuing}' options or if they have
an implied subprefix which has the \TT{line} group.
\\[2ex]
...
If the logical line is in paragraph beginning position and is also
preceeded by a sequence of logical lines prefixed by a
