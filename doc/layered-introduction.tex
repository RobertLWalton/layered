...
and {\em quoted-names}, that are arbitrary sequences of {\em word},
...
\label{PARSER-INDENTATION-MARK-COMMAND} \\
    ...
    $|$ & \ttikey{parser define concatenator}{define concatenator}
	  {\em concatenator}  \\
    \end{tabular}
...
\\[0.5ex]
\emkey{concatenator} ::= {\em quoted-name} with a single component
...
representing a MIN string (note natural-numbers represent MIN strings and
