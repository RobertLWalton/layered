...
The `\ttkey{lexeme map}'\label{STANDARD-LEXEME-MAP} standard component executes
the parser commands:
\begin{center}
\begin{tabular}{l@{\hspace*{0.5in}}l}
Parser Command				& Given Qualifiers
...
The `\ttkey{top level}' standard component executes
parser commands that include (see \pagref{STANDARD-TOP-LEVEL-1} and
