...
Module and bodies consist of a sequence
...
imported by that module.  It is a programming error to access
...
module it extends, and can call out-of-line functions in variable
assignments.
It can also declare internal names and functions used in the
body.
