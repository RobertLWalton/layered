...
an unchecked result deferred assignment if {\tt r} is a prototype
result variable with the \TT{*UNCHECKED*} qualifier (the qualifiers
of {\tt r} are determined by call-prototype matching).
...
bbi Ingerick <bingerick@twintierhospitality.com>
