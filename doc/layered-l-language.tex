...
\begin{tabular}{p{1in}@{~~~~~~}p{2in}@{~~~~~~}l}
\ttkey{unswrd}		& unsigned integer & size of integer register \\
\ttkey{intwrd}		& signed integer & size of integer register \\
\ttkey{floatwrd}	& floating point number & size of floating point
                                                          register \\
\end{tabular}
\end{indpar}
