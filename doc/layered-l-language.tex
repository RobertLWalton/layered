...
A {\em function-prototypes} can have implicit \TT{qualifiers} arguments.
...
a call.  This condition may use qualifier values and sets (as well
as type values and sets and constant numeric expression values and
sets), which \TT{\&} denoting set `AND' and `\TT{\textasciitilde}' denoting
...
bar int32 x = ...
boo int32 y = ...
int32 z = foo ( x )      // Illegal, Q must contain bar to
                         // match x with value, but condition
