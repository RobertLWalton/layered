...
does not have the {\tt *READABLE*} qualifier.
...
the value is writable into the element.\footnote{On modern INTEL 86\_64
...
For {\tt *ATOMIC* *PRE-WRITE*} the implementation ensures that all
following {\em atomic block} {\em write-instructions} write their
values to system memory \underline{after} the value written by
{\tt *ATOMIC* *PRE-WRITE*} has been stored in system memory.
