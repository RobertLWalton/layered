...
size (in which case if the {\tt p2} vector begins at a non-first
element of the {\tt p1} vector the copy will be from the ends of
...
{\tt p3.type}.  All vectors must be of the same length.
Element qualifiers are ignored.
