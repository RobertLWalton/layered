...
\emkey{variable-list}
    ...
    $|$ & \TT{(~}{\em qualifier}\STAR{} {\em type-name} {\em variable-name} \\
    $|$ & \TT{~~} \{ \TT{,} {\em qualifier}\STAR{} {\em type-name}
	             {\em variable-name} \}\STAR{} \TT{)} \\
    \end{tabular}
\end{indpar}
...
If this happens, the order in which the default subblocks execute
does not matter because (1) no two default subblocks may set the same
{\em variable-list} variable, (2) default subblocks execute after
any non-default subblock executes, and (3) variables allocated
