...
If an {\em assignment-statement} has \skey{result variable}s with given
{\em variable-names} and {\em variable-types}, these are allocated
to the current function frame, and
...
is a {\em function-call}, the {\em function-call}
itself returns a list of values, and this list of values is used.
