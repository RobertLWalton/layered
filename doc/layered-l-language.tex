...
If {\tt u} is a prototype result variable in a function call expansion,
...
added to {\tt u} for final result and ordinary assignments, but
not for deferred result and argument assignments; (2)
implied variable qualifiers of {\tt w} are implicitly added to
{\tt u} for final result assignments, but not for other assignments;
and (3) {\tt u} may have explicit variable qualifiers only for final result
assignments.
...
\underline{and} the assignment is a final result assignment or
ordinary assignment.
In this last case,
...
\item[(DA5)]
If the assignment is a final or deferred result assignment,
a \underline{variable} qualifier
of {\tt u} is also a qualifier of {\tt w}.
For deferred result assignments, the qualifiers of {\tt u}
are not explicit in the assignment,
but are those given by the call-prototype match.
\item[(DA6)]
If the assignment is a final or deferred result assignment,
a \underline{variable} qualifier
...
However, for a final result assignment,
