...
qualifier and is not {\tt implied},
...
For example,
\begin{indpar}\begin{verbatim}
define implied required value qualifier in-range
define prohibited value qualifier ouch
function Qs in-range T r =
        check (| qualifiers Qs, type T |) ( Qs T v ):
        // in-range is implied so Qs is implied to
        // be the non-implied value qualifiers of
...
ouch int32 y1 = check ( x )
           ...
           // Also y1 is given implied qualifier
           // `in-range'.
int32 y2 = check ( x )
