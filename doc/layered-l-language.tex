...
If an expression cannot be made to follow these rules, the expression
is ambiguous, which is a compile error.

After parsing as above, the parser inserts parentheses so that
...
done using an operator priority\footnote{Here priority is not quite
the same thing as precedence, so we use a different word for the
concept.}
table which for builtin operators is:
\begin{center}
\newcommand{\R}{$\rightarrow$}
\newcommand{\B}{$\leftrightarrow$}
\begin{tabular}{|l|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|}
\hline
& \multicolumn{15}{c|}{second operator} \\
\hline
first		& \B      & \B        & \B       & \B      & \R
		& \B      & \B        & \B       & \B      & \B      & \B
		& \B      & \B        & \B       & \B \\
operator 	& \TT{if} & \TT{else} & \TT{and} & \TT{or} & \TT{not}
                & \TT{<}  & \TT{<=}   & \TT{==}  & \TT{!=} & \TT{>=} & \TT{>}
		& \TT{+}  & \TT{-}    & \TT{*}   & \TT{/}
\\\hline
\B~\TT{if}	& x & < & > & > & > & > & > & > & > & > & > & > & > & > & > \\
...
\hline
& \multicolumn{12}{c|}{second operator} \\
\hline
first		& \B       & \B       & \B       & \B
                & \R     & \R
		& \B      & \B     & \B      & \B         & \B
		& \R \\
operator 	& \TT{div} & \TT{mod} & \TT{rem} & \TT{\textasciicircum}
		& \TT{+} & \TT{-}
		& \TT{\&} & \TT{|} & \TT{xor} & \TT{<{}<} & \TT{>{}>}
		& \TT{!}
\\\hline
...
\B~\TT{-}	& > & > & > & > & > & > & x & x & x & x & x & x \\
\hline
\B~\TT{*}	& x & x & x & > & > & > & x & x & x & x & x & x \\
\B~\TT{/}	& x & x & x & > & > & > & x & x & x & x & x & x \\
\B~\TT{div}	& x & x & x & > & > & > & x & x & x & x & x & x \\
\B~\TT{mod}	& x & x & x & > & > & > & x & x & x & x & x & x \\
\B~\TT{rem}	& x & x & x & > & > & > & x & x & x & x & x & x \\
\hline
\B~\TT{\textasciicircum}
		& x & x & x & > & > & x & x & x & x & x & x & x \\
\hline
...
\R~\TT{-}	& < & < & < & < & > & > & x & x & x & x & x & x \\
\hline
\B~\TT{\&}	& x & x & x & x & x & x & < & x & x & x & x & > \\
\B~\TT{|}	& x & x & x & x & x & x & x & < & x & x & x & > \\
\B~\TT{xor}	& x & x & x & x & x & x & x & x & < & x & x & > \\
\B~\TT{<{}<}	& x & x & x & x & x & x & x & x & x & < & < & > \\
\B~\TT{>{}>}	& x & x & x & x & x & x & x & x & x & < & < & > \\
\hline
\R~\TT{!}	& x & x & x & x & x & x & < & < & < & x & x & > \\
\hline
