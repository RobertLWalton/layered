...
copy down, copy up operations which we will describe here
to keep a stack address from being copied to variables higher
in the stack than the stack address.

Copying a value into a variable is done by an implied copy
operator.  If the variable is a function argument.
