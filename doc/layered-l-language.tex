...
must not be \TT{void} (but may have \TT{void} as its underlying type).
...
\item[(DA1)]
The types of {\tt u} and {\tt w} are identical and this type is not
\TT{void} (as per \pagref{DIRECT-ASSIGNMENT-TYPE-RULE}).
\item[(DA2)]
