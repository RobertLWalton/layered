...
\tt v = w		& Copy {\tt w} to {\tt v}:
                          assignment statement written in code. \\
\tt w $\Rightarrow$ v	& Copy {\tt w} to argument variable {\tt v}. \\
\tt v $\Leftarrow$ w	& Copy {\tt w} to result variable {\tt v}. \\
\end{tabular}
\end{center}

The second two kinds of assignments are generated by the compiler and cannot
