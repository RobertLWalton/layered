...
The `{\tt stack}' cache qualifier applied to a function argument or
return value also implies the `{\tt caller}'
lifetime qualifier.
...
A single qualifier may be of several types at once.  For example,
