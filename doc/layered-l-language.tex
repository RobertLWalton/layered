...
If there is an out-of-line function declaration, the \TT{*UNCHECKED*}
and \TT{*REVERSE*} options are ignored and have no effect.
...
\hspace*{0.5in}\begin{tabular}[t]{l}
		\TT{function type}
		    \{ {\em result-variable-list } \TT{=} \}\QMARK{} \\
		\TT{~~~~~~~~}{\em function-type-declaration-option}\STAR{}
...
\emkey{argument-variable-declaration}
    ...
    \end{tabular}
\\[0.5ex]
\emkey{function-type-declaration-option}
	\begin{tabular}[t]{rl}
	::= & \ttkey{*NO-RELOAD*} \\
	$|$ & \ttkey{*COMPILE-TIME*} \\
...
and names of argument varibles.
