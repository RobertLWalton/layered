...
\TT{prohibited~protected~qualifier~}\ttkey{stack} \\
...
type pointer pair is void
    ...
    //   unsadr pp.end points is the offset just
    //                 AFTER the last element
    //   adr pp.base is the base address that is added
    //               to the offsets
...
//
( pointer pair pp,
  stack unsadr pp.begin,
  stack unsadr pp.end,
  mem stack adr pp.base,
  stack adr pp.base.adr,
  type pp.type ) =
    ...
    unsadr offset = allocate to stack ( length )
        // This sets:
	//     stack unsadr offset
	//     mem stack adr offset.base
	//     stack adr offset.base.adr
...
( mem pp.type out,
  ...
  *UNCHECKED* stack out.offset.base.adr ) =
        "*" ( pointer pair pp,
              type pp.type,
              stack unsadr pp.begin,
              stack unsadr pp.end,
    ...
    if:
        pp.begin < pp.end:
            *UNCHECKED* unsadr offset = pp.begin
            adr mem offset.base
            *UNCHECKED* adr offset.base.adr = pp.base
            in ---> offset
        else:
            fatal error
                ( "Deferencing empty pointer pair." )
...
//
( pointer pair pp2,
  stack unsadr pp2.begin,
  stack unsadr pp2.end,
  stack mem adr pp2.base,
  stack adr pp2.base.adr,
  type pp2.type )
        "++" ( pointer pair pp,
               type pp.type,
               stack unsadr pp.begin,
