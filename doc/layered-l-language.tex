...
first true condition are executed.  Each separate group of
...
This is somwhat like the conditional assignment statement
...
( mem pointer pair pp,
  unsadr pp.begin, unsadr pp.end, type pp.type ) =
    ...
    pp.type = T;
    pp.begin = allocate ( T, n );
    pp.end = pp.begin + sizeof ( T ) * n;
...
// write memory.
//
mem "*" ( mem pointer pair pp, unsadr pp.begin, unsadr pp.end,
                               type pp.type ) =
        ( pp.type in ):
    if:
        pp.begin < pp.end:
...
// pair.  Note the result is a NEW pointer pair.
//
( pointer pair pp2, unsadr pp2.begin, unsadr pp2.end,
                    type pp2.type )
    "++" ( pointer pair pp, type pp.type,
                            unsadr pp.begin, unsadr pp.end ):
      pp2.begin = pp.begin + sizeof ( T )
      pp2.end = pp.end;
      pp2.T = pp.T

// Example usage:
//
TBD: out of line function header
