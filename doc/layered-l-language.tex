...
is implied.
\item[NOTE]
Deferred result assignments, which ignore qualifiers, are always direct
assignments if (DA1) is satisfied.
\end{itemize}\end{indpar}

Deferred result assignments that change qualifiers may violate
...
Examples involving the \TT{*MEM*} and \TT{*UNCHECKED*}
