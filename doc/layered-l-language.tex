...
The \TT{*UNCHECKED*} operator is defined as follows:
\begin{itemize}
\item The implicit conversion `$t2$ \TT{<{}<++} $t1${\em -value}'
is defined.
...
equals module $2^n$ the integer part of the $t1$-value,
...
nearest values, the one with a zero low order bit is chosen.
\end{itemize}
