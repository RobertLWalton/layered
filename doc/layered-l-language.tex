...
{\em variable-list} cannot be read by a subblock {\em statement}
...
If a variable \TT{v} not in the {\em variable-list}
...
{\em function-definition's} subblock {\em statements} becoming the 
{\em block-assignment-statement's} subblock {\em statements}.
...
its value can be used as some of the qualifiers
of other argument variables that are
after it in the {\em argument-variable-list},
or of any result variable.  For example:
\begin{indpar}\begin{verbatim}
( Qr pointer result ) =
