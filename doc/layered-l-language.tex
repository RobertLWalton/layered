...
\begin{itemize}
\item \TT{T1~=>~T2} is reflexive.  \TT{T1~>=~T1}.
\item \TT{T1~=>~T2} is transitive.  \TT{T1~>=~T2} and \TT{T2~>=~T3}
imply that \TT{T1~=>~T3}.
\item \TT{T1~=>~T2} is anti-symmetric.  \TT{T1~>=~T2} and \TT{T2~>=~T1}
imply that \TT{T1~==~T2}.
\end{itemize}
...
gives the same resulting value as converting the \TT{T1} value
...
\item If \TT{T-src} and \TT{T-des} are not the same and \TT{T1~=>T2},
meaning that an implicit conversions are defined that convert values
of type \TT{T1} to values of type \TT{T2}, these conversions are
...
If \TT{T-src} and \TT{T-des} are not the same and \TT{T1~=>T2}
...
\begin{center}
\begin{tabular}{l}
\TT{QS-F-result T-F-result F-result =} \\
\TT{~~~~~~~~~~~~F ( QS-F-argument T-F-argument F-argument)} \\
\TT{QS-G-result T-G-result G-result =} \\
...
than one prototype.
See the Conversion Disambiguation Section~\itemref{CONVERSION-DISAMBIGUATION}.
