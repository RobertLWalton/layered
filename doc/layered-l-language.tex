...
using unchecked conversions, though relative order may differ
somewhat from one program execution to the next.
...
by the same function call assignment statement, and that
\TT{v.adr} be given the \TT{*UNCHECKED*} qualifier by that function
...
of a {\em call-assignment-statement} or {\em loop-assigment-statement},
...
protection qualifier that must qualify the \TT{v.adr} variable
