...
list of {\em function-terms}.  However, the first {\em function-term}
...
in that
{\em pattern-names} must match exactly, after adjustments are
made as described below for alternatives and booleans, and
{\em opening/closing-argument-brackets} must match exactly,
...
\hspace*{-0.3in}{\tt (unsadr size) = \ttmkey{count}{of {\tt pattern name}}
			( pattern name N )} \\
Number of repetitions of the {\em pattern-term} containing the
pattern name in the unfolded pattern.  \TT{0} if the {\em pattern-term}
was deleted.
