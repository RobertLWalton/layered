...
\\[0.5ex]
\emkey{pattern-term}
    ::= {\em function-term-name} ~ {\em pattern-argument-list}\PLUS{}
\\[0.5ex]
...
{\em expression} ::= see \pagref{EXPRESSION}
\\[0.5ex]
\emkey{primary-argument} ::= {\em primary-item} $|$ {\em bracketed-constant}
\\[0.5ex]
{\em primary-item} ::= see \pagref{PRIMARY-ITEM}
\\[0.5ex]
...
\item
If a {\em function-pattern}
{\em argument-list} begins with a {\em type-argument-declaration}
(an {\em argu\-ment-declaration} of the form `{\tt type }{\em variable-name}')
...
If this rule applies, the type value given to the {\em variable-name}
is substituted for the {\em variable-name} throughout the
...
of a prototype result variable with a matching actual result that
has a known type,
...
is removed from the beginning of its {\em function-pattern}
{\em argument-list}, and
the type value given to the {\em variable-name}
is substituted for the {\em variable-name} throughout the
{\em function-prototype}.

\item
If a {\em function-pattern}
{\em argument-list} begins with a {\em qualifiers-argument-declaration}
(an {\em argu\-ment-declaration} of the form
`{\tt qualifiers }{\em variable-name}'),
and the matching actual argument list begins with an
...
If this rule applies, the list of qualifiers given as a value
to the {\em variable-name}
is substituted for the {\em variable-name} throughout the
{\em function-prototype}.
...
actual result with known qualifiers,
the qualifiers of the actual result is assigned as the
...
is removed from the beginning of its {\em function-pattern}
{\em argument-list}, and
the list of qualifiers given as a value
to the {\em variable-name}
is substituted for the {\em variable-name} throughout the
{\em function-prototype}.
...
\item
If some of the actual argument lists are now too short, they are extended
