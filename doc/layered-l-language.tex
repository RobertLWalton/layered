...
no \underline{variable} qualifier of {\tt u} may be protected.
\item[(DA5)]
If the assignment is not a result assignment (see below),
{\tt w} may have any \underline{variable} qualifier and
{\tt u} may have any \underline{un-protected} \underline{variable} qualifier.
\end{itemize}\end{indpar}
...
of {\tt r} must also be a qualifier of {\tt u} unless
...
\item[(DA8)]
If the assignment is a result assignment,
a \underline{protected} \underline{variable} qualifier
of {\tt r} that is not an explicit
qualifier of {\tt u} is implicitly added to {\tt u}.
\end{itemize}\end{indpar}
Thus result assignments treat variable qualifiers as if they
were value qualifiers, except for protected qualifiers, which
are allowed and added by implication.
