...
a stack by the `\TT{allocate to stack}' function described below, and this may
...
The `\TT{stack}' qualifier has the property that given a variable
with this qualifier may \underline{not} be matched to an argument
that does not have the `\TT{stack}' qualifier.  Thus only
functions whose arguments have the `\TT{stack}' qualifier may
input values that have this qualifier.
