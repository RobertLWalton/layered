...
uns64 *& .n ( *& myarray a ) unchecked = a@0;
...
`{\tt constant}' memory locations can be cached in registers
without restriction.

The `{\tt constant}' qualifier obeys the following special rule:
it is removed from a location passed to the {\tt .constructor.}
