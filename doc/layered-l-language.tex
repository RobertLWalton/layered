...
is illegal and a compile error.  If the expression can be made to follow
these rules in more than one way, the expression
is ambiguous, and is a compile error.
...
\begin{center}
\newcommand{\IX}[1]{$^{\bullet}$\TT{#1}$^{\bullet}$}
\newcommand{\RX}[1]{\TT{#1}$^{\bullet}$}
\newcommand{\LX}[1]{$^{\bullet}$\TT{#1}}
