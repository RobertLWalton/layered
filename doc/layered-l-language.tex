...
{\tt function \TT{*UNCHECKED* deallocate dynamic block}%
...
A non-top level {\em global-area-block} is to be executed at either
compile-time or run-time, it is executed the \underline{first time}
its smallest containing subblock is executed.  Non-top level
...
can be used to find the dynamic block that is the areas' global stack.
