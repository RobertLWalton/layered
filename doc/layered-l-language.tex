...
\begin{indpar}
\begin{tabular}{p{0.8in}@{\TT{~--->~}}l}
\TT{uns1} & \TT{`std~}\ttkey{uns1}\TT{'} \\
\TT{uns8} & \TT{`std~}\ttkey{uns8}\TT{'} \\
\TT{uns16} & \TT{`std~}\ttkey{uns16}\TT{'} \\
\TT{uns32} & \TT{`std~}\ttkey{uns32}\TT{'} \\
\TT{uns64} & \TT{`std~}\ttkey{uns64}\TT{'} \\
\TT{uns128} & \TT{`std~}\ttkey{uns128}\TT{'} \\
\end{tabular}

\begin{tabular}{p{0.8in}@{\TT{~--->~}}l}
\TT{int8} & \TT{`std~}\ttkey{int8}\TT{'} \\
\TT{int16} & \TT{`std~}\ttkey{int16}\TT{'} \\
\TT{int32} & \TT{`std~}\ttkey{int32}\TT{'} \\
\TT{int64} & \TT{`std~}\ttkey{int64}\TT{'} \\
\TT{int128} & \TT{`std~}\ttkey{int128}\TT{'} \\
\end{tabular}

\begin{tabular}{p{0.8in}@{\TT{~--->~}}l}
\TT{float16} & \TT{`std~}\ttkey{float16}\TT{'} \\
\TT{float32} & \TT{`std~}\ttkey{float32}\TT{'} \\
\TT{float64} & \TT{`std~}\ttkey{float64}\TT{'} \\
\TT{float128} & \TT{`std~}\ttkey{float128}\TT{'} \\
\end{tabular}

\begin{tabular}{p{0.8in}@{\TT{~--->~}}l}
\TT{unsadr} & \TT{`std~}\ttkey{unsadr}\TT{'} \\
\TT{intadr} & \TT{`std~}\ttkey{intadr}\TT{'} \\
\TT{adr} & \TT{`std~}\ttkey{adr}\TT{'} \\
\end{tabular}

\begin{tabular}{p{0.8in}@{\TT{~--->~}}l}
\TT{unswrd} & \TT{`std~}\ttkey{unswrd}\TT{'} \\
\TT{intwrd} & \TT{`std~}\ttkey{intwrd}\TT{'} \\
\TT{floatwrd} & \TT{`std~}\ttkey{floatwrd}\TT{'} \\
\end{tabular}
\end{indpar}
...
\begin{indpar}
\TT{function uns$x$~~~r = std uns$x$~~~( uns$y$ v )} \\
\TT{function int$x$~~~r = std int$x$~~~( uns$y$ v )} \\
\TT{function float$x$~r = std float$x$~( uns$y$ v )} \\
\TT{function int$x$~~~r = std int$x$~~~( int$y$ v )} \\
\TT{function float$x$~r = std float$x$~( int$y$ v )} \\
\TT{function float$x$~r = std float$x$~( float$y$ v )}
...
\TT{function uns$x$~~~r = std mod~~~( uns$y$ v )} \\
\TT{function uns$x$~~~r = std mod~~~( int$y$ v )} \\
\TT{function int$x$~~~r = std mod~~~( uns$y$ v )} \\
\TT{function int$x$~~~r = std mod~~~( int$y$ v )}
\ttindex{mod}
...
\TT{function uns$x$~~~~~r = std nearest~~~( uns$y$ v )} \\
\TT{function uns$x$~~~~~r = std nearest~~~( int$y$ v )} \\
\TT{function uns$x$~~~~~r = std nearest~~~( float$y$ v )} \\
\TT{function int$x$~~~~~r = std nearest~~~( uns$y$ v )} \\
\TT{function int$x$~~~~~r = std nearest~~~( int$y$ v )} \\
\TT{function int$x$~~~~~r = std nearest~~~( float$y$ v )} \\
\TT{function float$x$~~~r = std nearest~~~( uns$y$ v )} \\
\TT{function float$x$~~~r = std nearest~~~( int$y$ v )} \\
\TT{function float$x$~~~r = std nearest~~~( float$y$ v )}
\ttindex{nearest}
...
\begin{indpar}
\TT{function float$x$~~~r = std round~~~~~( float$x$ v )} \\
\TT{function float$x$~~~r = std ceiling~~~( float$x$ v )} \\
\TT{function float$x$~~~r = std floor~~~~~( float$x$ v )}
...
\begin{indpar}
\TT{function *UNCHECKED* uns$x$~~~r = uns$x$ ( int$x$ v )} \\
\TT{function *UNCHECKED* uns$x$~~~r = uns$x$ ( float$x$ v )} \\
\TT{function *UNCHECKED* int$x$~~~r = uns$x$ ( uns$x$ v )} \\
\TT{function *UNCHECKED* int$x$~~~r = uns$x$ ( float$x$ v )} \\
\TT{function *UNCHECKED* float$x$~r = uns$x$ ( uns$x$ v )} \\
\TT{function *UNCHECKED* float$x$~r = uns$x$ ( int$x$ v )}
...
builtin functions:
\begin{indpar}
\TT{function *UNCHECKED* $B$ r = $B$ ( $D$ v )} \\
\TT{function *UNCHECKED* $D$ r = $D$ ( $B$ v )}
...
\begin{indpar}
\TT{function $B$ r = $B$ ( $E$ v )} \\
\TT{function *UNCHECKED* $B$ r = $B$ ( $E$ v )} \\
\TT{function *UNCHECKED* $E$ r = $E$ ( $B$ v )}
\begin{indpar}
...
following are defined, where \TT{I} is the underlying
integer type of \TT{E}:

\begin{indpar}
\TT{function $I$ r = enumeration offset of ( type E )}
\begin{indpar}
Returns the enumeration offset of \TT{E}.
\end{indpar}
\TT{function $I$ r = range value of ( $E$ v )}
\begin{indpar}
Returns \TT{$I$ ( v ) - enumeration offset of ( $E$ )}.
\end{indpar}
...
\begin{indpar}
\TT{function bool r = ( $E$ v1 ) "$cop$" ( $E$ v1 )}

where $cop$ is \TT{<}, \TT{<=}, \TT{==}, \TT{!=}, \TT{>=}, or \TT{>}.
\begin{indpar}
Returns \TT{$I$(v1) "$cop$" $I$(v2)}.
\end{indpar}

\TT{function $I$ r = ( $E$ v1 ) "-" ( $E$ v1 )}
\begin{indpar}
Returns \TT{$I$(v1) "-" $I$(v2)}.
\end{indpar}
\end{indpar}
...
\TT{type~}\ttmkey{missing}{type}\TT{~is next enum // 0} \\
\TT{type~}\ttkey{type}\TT{~is next enum // 1}
\\[1ex]
\TT{type~}\ttkey{qualifier}\TT{~is unswrd with enum [0~..]} \\
\TT{qualifier~}\ttmkey{missing}{qualifier}\TT{~is next enum // 0}
\\[1ex]
...
\begin{center}
\TT{type} {\em qualifier-name}\STAR{} {\em enum-set-type-name}
    \TT{is set of } {\em base-enum-type-name} \\
\TT{type} {\em qualifier-name}\STAR{} {\em enum-list-type-name}
