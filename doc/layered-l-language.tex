...
Assignment statements may remove required qualifiers
but not add them.
Assignment statements may add prohibited qualifiers
but not remove them.  Implicit conversions defined by
prototypes of the form
\begin{center} \tt
\begin{tabular}{l}
function Qs~$T2$ r = \\
\hspace*{0in}~~~~~~~~~\ttkey{implicit conversion} (| qualifiers Qs |)
                          ( Qs~$T1$ v )
\end{tabular}
\end{center}
behave similarly.
