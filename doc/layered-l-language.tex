...
of {\tt w}, and $Qsu$, $Tu$ are similarly for {\tt u},
the compiler will assign the value of {\tt w} to the variable {\tt v}
...
must be identical.
\item[(DA2)]
A value qualifier of {\tt w} must also be a qualifier of {\tt u} unless
the qualifier is deletable.
\item[(DA3)]
A value qualifier of {\tt u} must also be a qualifier of {\tt w} unless
the qualifier is addable.
\item[(DA4)]
No variable qualifier of {\tt u} may be protected.
\end{itemize}\end{indpar}
