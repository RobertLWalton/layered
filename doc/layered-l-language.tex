...
the value when it is converted to the new type.  These functions
can be \ikey{implied}{implicit conversion} in approprate
circumstances.
\end{indpar}
\end{indpar}
...
The following builtin conversion functions lose information
for some values:
\begin{center}
