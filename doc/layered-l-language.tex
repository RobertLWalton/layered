...
the {\em module-abbreviation} of the module.  This makes the
declaration `\key{external}'.
...
that are not top level or are in a body file, and not a module file,
\underline{must} be internal.

Also, {\em abbreviation-declarations} are always internal
(\pagref{ABBREVIATIONS-ARE-INTERNAL}),
