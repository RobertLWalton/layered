...
A variable of type \ttkey{name} can store a name.  Name
constants are made by \TT{`~'} quoting a {\em name}.
Names can be concatenated by the \TT{+} operator.  An
example is:
\begin{indpar}\begin{verbatim}
name n = `my name'
name n2 = `her name.husband[3]'
name n3 = n + n2  // n3 now = `my name her name.husband[3]'
\end{verbatim}\end{indpar}
...
\begin{indpar}\begin{verbatim}
name ni is i  // same as: name ni = `i'; abbreviation ni
\end{verbatim}\end{indpar}
