...
Types are declared by `{\tt define type}' statements which have the
syntax
...
{\em type-name}
& ::= & {\em simple-name} \\
& $|$ & {\em argumented-name} {\em argumented-name}$^\star$ \\
& $|$ & {\em argumented-name} {\em argumented-name}$^\star$ {\em simple-name} \\
{\em argumented-name}
& ::= & {\em simple-name} {\em argument-list}
                          {\em argument-list}$^\star$ \\
{\em argument-list}
& ::= & {\tt (} {\em variable-declaration}
        \{ {\tt ,} {\em variable-declaration} \}$^\star$ {\tt )} \\
{\em type-spec}
& ::= & {\tt (} {\em length}{\tt ,}
