...
int32 * stack * function4 ( int32 arg1 );
...
each of the location's qualifier expression must evaluate to true
...
Second, every other qualifier is given the value true if and only if
doing so is necessary and sufficient to make the expression true, and
is otherwise given the value false.  Any non-protection qualifiers
given the value true for any qualifier expression of the location then
qualify the location when it is accessed by the function.
