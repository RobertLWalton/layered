...
RAM memory using the address in {\tt r.adr}: see \itemref{THE-READ-QUALIFIER}.
...
global memory,
but see \pagref{READ} and Section~\itemref{THE-READ-QUALIFIER}
...
See \itemref{THE-READ-QUALIFIER} for more on the \TT{*READ*} qualifier.
...
see \itemref{THE-READ-QUALIFIER}.
...
The builtin qualifiers are \TT{*READ*}, \TT{*WRITE*}, \TT{*UNCHECKED*},
and \TT{*STACK*}.
...
\subsection{The \TT{*READ*} and \TT{*WRITE*} Memory Qualifiers}
\label{THE-READ-QUALIFIER}
...
\begin{indpar}\begin{verbatim}
    function *READ* *WRITE* r, adr r.adr = foo ( ... ):
        . . . . . . . . . .
    int32 v = foo ( ... )
...
(as per Section~\itemref{THE-READ-QUALIFIER}), then if \TT{v} is declared
...
stored in RAM.  See Sections~\itemref{THE-READ-QUALIFIER}
...
see Section~\itemref{THE-READ-QUALIFIER}.
...
the rules of Section~\itemref{THE-READ-QUALIFIER}.
