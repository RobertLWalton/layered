...
which is basically a small integer that identifies the type, and
can be associated with {\em type-names}.  Types can be computed
...
identifier of a type (\itemref{TYPE-VALUES}).
