...
\hspace*{0.5in}\begin{tabular}[t]{l}
        {\em variable-list} \TT{=} \TT{*UNCHECKED*}\QMARK \TT{*REVERSE*}\QMARK
...
\begin{center}
\TT{function type} {\em result-variable-list } \TT{=} {\em defined-type-name}
...
\TT{*REVERSE*} qualification reverses this order.

Normally the standard call linkage for the computer environment of
the program is used.  Other implementation specific qualifications
may alter the call linkage used if the call is \TT{*UNCHECKED*},
or such qualifications may be applied to the function's type and
