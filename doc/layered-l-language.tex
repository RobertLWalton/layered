...
\item If \TT{T-src} and \TT{T-des} are not the same and a
...
value of \TT{v-des}.  The conversion is invoked with \TT{QS == QS-src},
and is called an \key{implied conversion}.
...
\end{center}
this conversion is applied.  Such a conversion is called a
\key{directed conversion}.

In the case the function prototype
has the form
\begin{center}
\TT{QS *UNCHECKED* T-des} {\em result-variable}%
    ~~\TT{=}~~\TT{( qualifiers QS, QS T-src} {\em source-variable} \TT{)}
\end{center}
