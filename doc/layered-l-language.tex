...
Strings are implemented at compile time, but when
computed at compile time, they might not be garbage collectable.

Strings may or may not be implemented at run-time, and if they are,
will have library implementation dependent memory allocation
schemes.

The following are builtin functions involving strings that
are always implemented at compile time:
...
Name values are implemented at compile time, but when
computed at compile time, they might not be garbage collectable.

Name values may or may not be implemented at run-time, and if they are,
will have library implementation dependent memory allocation
schemes.

The following are builtin functions involving name values that
are always implemented at compile time:
