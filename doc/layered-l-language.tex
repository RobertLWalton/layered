...
\emkey{function-term}
    \begin{tabular}[t]{@{}rl}
    ::= & {\em function-factor}\PLUS{} {\em function-term-modifier}\QMARK{}
    \end{tabular}
\\[0.5ex]
\emkey{function-factor}
    \begin{tabular}[t]{@{}rl}
    ::= & {\em function-factor-name} \\
    $|$ & {\em argument-variable-list} \\
    \end{tabular}
\\[0.5ex]
\emkey{function-term-modifier} ::= \TT{?} $|$ \TT{...}
\\[0.5ex]
\emkey{function-factor-name} ::= {\em name} see \pagref{NAMES}
\\[1ex]
