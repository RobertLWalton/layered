...
the direct address of the direct address of \ldots{} the direct address
...
number if $M=N$, and to get previous direct addresses one must put a
{\tt \&} in front of the variable name, whereas to get subsequent direct
addresses one puts a {\tt *} in front.
