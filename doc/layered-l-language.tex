...
\emkey{function-initial-term-name} ::=
    \begin{tabular}[t]{@{}l@{}}
    {\em function-term-name} that can appear \\
    at the beginning of a {\em function-call};
...
fee int32 y4 = G ( y3 )      // Illegal; y3 has implied
                             // qualifier fo.
fo  int32 y5 = F ( x1 )      // Illegal; fo is protected, ans
                             // F does not have fo on its
                             // prototype result variable.
fo  int32 y5 = 9             // Illegal; fo is protected,
                             // and 9 has no qualifiers.
fo  int32 y6 = G ( x1 )      // Legal; G gives y7 the
                             // protected fo qualifier so its
                             // OK for y7 to have that
                             // qualifier.
fo  int32 y7 = y3            // Legal; y3 has implied fo.
\end{verbatim}\end{indpar}
...
or of any {\em type-name}, or of any {\em function-initial-term-name}.
