...
\item[(DA2)]
If the assignment is not a deferred result assignment,
...
\item[(DA5)]
If the assignment is a final result assignment,
...
or must be assigned its value by a final result assignment whose prototype
result variable {\tt w} has the qualifier.  In the latter case,
{\tt u} need not be given the qualifier explicitly if the qualifier
is implied.
\item[NOTE]
Deferred result assignments ignore qualifiers and are always direct
