...
value \TT{NULL} (defined below).  Body pointer addresses must be
...
{\tt function unsadr r = \begin{tabular}[t]{@{}l@{}}
                         \TT{std allocate to dynamic}%
	                 \index{allocate@{\tt allocate}!%
...
\underline{must} be set to \TT{NULL} (defined below).
...
This offst is a multiple of the the given {\tt alignment} in bytes.
...
{\tt function adr r = \ttstdkey{STATIC BASE}}\label{STATIC BASE}
