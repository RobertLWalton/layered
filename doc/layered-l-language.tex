...
are the equivalent of out-of-line function calls.  In actual practice,
...
Memory locations may also be placed in hardware caches.  In hardware
...
two canonical {\em type-overlap-expressions} overlap if only
