...
(see \pagref{RESULT-DIRECT-ASSIGNMENTS}).
...
value of {\tt w} to {\tt v}, but result direct assignments are an exception%
\label{RESULT-DIRECT-ASSIGNMENTS}.
A result direct assignment in effect makes {\tt u} an alternative name for
