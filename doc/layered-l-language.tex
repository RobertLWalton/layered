...
However, type values are not very useful at runtime, as the only
operations on them are equality comparison and output.
Most runtime information about type is encoded in type descriptors.
...
\begin{indpar}\begin{verbatim}
type descriptor unsadr size ( type T ):
    basic(T) b
    return b.size
\end{verbatim}\end{indpar}
