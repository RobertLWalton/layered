...
type E3 is next E2 with enum range [1 .. 5]
    // Now enumeration offset of (E2) == 11
E3 C3 = next enum 
    // Now range value of (C3) == 1,
    // range value of ( E2(C3) ) == 2,
    // range value of ( E1(E2(C3)) ) = 11 = int32(C3)
\end{verbatim}\end{indpar}
...
can be assumed to be the same if \underline{all} values of the enumeration type
are assigned in the a single compilation module.
