...
\subsection{Pointer Memory Allocators}
\label{POINTER-MEMORY-ALLOCATORS}
...
~~~~~~~~[| zero value OK for T |] \\
~~~~~~~~[| Qs are all addable |] \\
\end{tabular}\end{indpar}\label{POINTER-ALLOCATE-TO-STACK}
...
\begin{indpar}\tt\begin{tabular}{@{}l}
function *UNCHECKED* *STACK* *READABLE* *WRITABLE* pointer p, \\
~~~~~~~~~~~~~unsadr p.begin, \\
~~~~~~~~~~~~~unsadr p.end, \\
~~~~~~~~~~~~~*READ* adr p.base, \\
~~~~~~~~~~~~~adr p.base.adr, \\
