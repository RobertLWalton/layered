...
A variable may be declared to be an abbreviation.  When a name
...
name nnj = `nj'
abbreviation ni
int32 ni = 5       // Legal: same as i = 5
int32 nj = 6       // Illegal variable overlay: same as nj = 6.
abbreviation nj, nnj
int32 nj = 6       // Legal: same as j = 6
int32 r = nnj      // Legal: same as r = j (now nnj => nj => j)
int32 nnj.p = 4    // Legal: same as j.p = 4
name .p = `.q'
int32 nnj.p = 4    // Illegal variable overlay: same as j.p = 4
abbreviation .p
int32 nnj.p = 4    // Legal: same as j.q = 4
int32 nnj.p[0] = 4 // Legal: same as j.q[0] = 4
\end{verbatim}\end{indpar}
...
\begin{indpar}\begin{verbatim}
name ni is i  // same as: name ni = `i'
              //          abbreviation ni
\end{verbatim}\end{indpar}

The syntax of these declarations is:

\begin{indpar}
{\em abbreviation-declaration-statement} ::=
    \TT{abbreviation} ~~ {\em name} ~~ \{ \TT{,} {\em name} \}\STAR{} \\[1ex]
{\em name-declaration-statement} ::=
    \TT{name} ~~ {\em abbreviating-name} ~~ \TT{is} ~~ {\em abbreviated-name}
\end{indpar}

An {\em abbreviation-declaration-statement} must name variables whose
names are in scope (see Section~\itemref{SCOPES}) and whose type is
`\TT{name}'.
...
{\em assigment-statements} or {\em executable-statements} as for
