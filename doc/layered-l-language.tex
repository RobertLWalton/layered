...
In the operator precedence tables the symbol \TT{\{} is used to denote
the beginning of the expression and the symbol \TT{\}} is used to denote
the end of the expression.  Applying these rules,
...
must have \IX{if} as its `\mkey{topmost}{operator}'
