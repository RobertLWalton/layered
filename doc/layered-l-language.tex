...
\emkey{function-prototype}
    ...
    $|$ & {\em function-name} {\em argument-variable-list}\QMARK{}
            \TT{=} {\em input-variable-list}\TT{:} \\
    \end{tabular}
\end{indpar}

A function call is in effect replaced by a {\em block-assignment-statement}
...
Actual arguments from the function call are mapped to varibles in
