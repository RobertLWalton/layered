...
within the {\em function-declaration}
...
Otherwise if {\tt Qs} is the given as a qualifier of a prototype
result variable, and there is a corresponding {\em function-call}
result variable, the qualifiers of that call result variable are
assigned as the value of {\tt Qs}.  Otherwise
if {\tt Qs} is given as the qualifiers of some prototype argument variables,
...
For example,
\begin{indpar}\begin{verbatim}
define required protected qualifier in-range
function ( Qs in-range T result ) =
        check ( qualifiers Qs, type T, T v ):
    if:
        v < 0:
	    error
	v > 100:
...
F ( y )    // Legal, y has protected in-range
\end{verbatim}\end{indpar}
