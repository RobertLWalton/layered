...
No executable code is used, no new register is allocated, and no new
...
\label{VARIABLE-RESUSE}

Two variables in the same block of code may not have the same
name.  Thus variable are only assigned values once.
...
variables that it does for other variables.
