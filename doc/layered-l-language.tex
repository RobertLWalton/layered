...
\begin{indpar}
\emkey{type-name} ::= {\em name} not containing a `\TT{.}',
			 {\em quoted-mark}, or {\em quoted-separator} \\
\emkey{qualifier-name} ::= {\em name} not containing a `\TT{.}',
			 {\em quoted-mark}, or {\em quoted-separator} \\
\emkey{variable-base} ::= {\em name} not containing a `\TT{.}',
			 {\em quoted-mark}, or {\em quoted-separator} \\
\emkey{variable-name} ::= {\em variable-base} {\em member-selector}\STAR{} \\
\emkey{member-selector} ::= {\em member-name} $|$ {\em member-subscript } \\
\emkey{member-name} ::= \begin{tabular}[t]{@{}l@{}}
...
{\em type-name}, of a {\em variable-base}, or of a {\em term-name}
...
{\em qualifier-name}, of a {\em type-name}, of a {\em variable-base},
...
and in {\em prototype-argument-declarations}.  Also, a
{\em function-call} beginning with a {\em term-name}
may also begin a {\em statement}.
The third rule is because the compiler generates names like \TT{T\TMP$n$}
...
\emkey{bit} :::= \TT{0} $|$ \TT{1}
 \\[0.5ex]
\emkey{hexadecimal-constant} ::: = {\em sign}\QMARK{} \TT{X\#} {\em hexadecimal-integer}
...
{\em qualifier-name} ::= {\em name} not containing a `\TT{.}',
			 {\em quoted-mark}, or {\em quoted-separator} \\
