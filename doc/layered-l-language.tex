...
\begin{indpar}
\emkey{atomic-statement} ::= {\em atomic-block} $|$ {\em atomic-read-statement}
\\[0.5ex]
\emkey{atomic-block} ::= \\
\hspace*{0.5in}\begin{tabular}[t]{l}
...
\emkey{atomic-write-instruction} ::=
        \ttalkey{ATOMIC}{WRITE} {\em atomic-value} {\em atomic-pointer} \\
...
\emkey{atomic-post-read-statement} ::= \\
\hspace*{0.5in}{\tt uns32 r =
