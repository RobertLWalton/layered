...
For defined types it is the size of their base type.
...
For defined types it is the alignment of their base type.
...
minimum and maximum of the base type, and not the assigned
enumeration values.
