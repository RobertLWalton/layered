...
\begin{center} \tt
function \ldots~$T2$ r = implied conversion ( \ldots~$T1$ v )
\end{center}
must be defined.
This last rule
...
in the implicit conversion greaph, both paths produce the same
result.  For example:
\begin{indpar}\begin{verbatim}
int16 v1 = ...
int32 v2 = v1
...
Only some of these functions have a default declaration.
