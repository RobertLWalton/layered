...
A \key{stub/body object} consists of a dynamic block called the
object's \key{body} and a static block called the object's \key{stub}
that contains a pointer to the body.

A pointer to a location in the body of a stub/body object
consists of an \TT{adr} value
pointing to the object's stub and an \TT{unsadr} (or \TT{intadr})
