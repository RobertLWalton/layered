...
Within the body of a function, cluster variables with
{\em function-pattern} {\em variable-names} a bases can be used
to obtain information about replication of pattern terms.
If \TT{V} is a variable name, then we have:

\begin{indpar}[0.5in]

\hspace*{-0.3in}{\tt unsadr V.\ttmkey{count}{of {\tt variable name}} } \\
Number of of times the variable name \TT{N} appears in the unfolded
pattern.  This is \TT{1} if the {\em pattern-term} containing \TT{N}
is not replicated or omitted, and \TT{0} if it is ommitted.
