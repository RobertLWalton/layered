...
\end{verbatim}\end{indpar}
Locations specify as a specific set of bytes.  Note that unlike
...
int32 *& Q function4 ();
\end{verbatim}\end{indpar}
Note that in this last case qualifiers appearing before function names
in function definitions and declarations are always assumed to apply
to the function and not the returned value.

If in the above examples applying {\tt Q} to functions we assume that
{\tt Q} is a protection qualivier, then {\tt function3}
