...
\emkey{else-expression}
    ...
    $|$ & {\em else-left-expression} \ttkey{else} {\em else-right-operand} \\
    \end{tabular}
\\[0.5ex]
\emkey{else-left-expression}
    \begin{tabular}[t]{rl}
    ::= & {\em else-left-operand} \ttkey{else} {\em else-left-operand} \\
    $|$ & {\em else-left-expression} \ttkey{else} {\em else-left-operand} \\
    \end{tabular}
\\[0.5ex]
...
\begin{indpar}\begin{verbatim}
define right asymetric left associative
                       "else" operator "else"
...
define left asymetric left associative
                      "shift" operators "<<", ">>"
