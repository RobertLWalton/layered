...
Similarly qualifiers may appear before types, and qualifiers are
recognized because they are declared as such in advance.

Names may be either `\mkey{complete}{name}' or `\mkey{prototype}{name}'.
In a complete name all argument values are given.  In a prototype
