...
consecutive physical lines differ by more than \TT{0} and
...
within inline functions, generics, or
...
The name or the pattern of a prototype
...
Statements initializing their variables or functions must be executed
before the variable values or functions are used.
...
The `\TT{allocate to stack}' inline functions may move stacks and
