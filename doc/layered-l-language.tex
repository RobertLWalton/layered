...
int function1 ( int * stack * arg1 );
    ...
    // in this location, and function2 can return a pointer to an int
    // value in this location but cannot reset the argument.
...
frame or pass the address to another function where the location is
declared `{\tt stack}'.  TBD
...
know exactly where the address of the frame may be stored.  If the
