...
activities.  There are two kinds of traceable qualifiers:
\skey{traceable location qualifier}s specify that a location stored in
static memory or a thread stack must be findable by system maintenance
activities,
and \skey{traceable value qualifier}s specify that a location can only
