...
{\tt define implied deletable value qualifier \ttkey{std *WRITABLE*}} \\
...
If $QC.$ contains the \ttamkey{MEM}{in call-prototype match}
...
See \itemref{THE-MEM-QUALIFIER} for more on the \TT{*MEM*} qualifier.
...
//
function *STACK* *WRITABLE* pointer pair pp,
         unsadr pp.begin,
         unsadr pp.end,
         *MEM* adr pp.base,
         adr pp.base.adr,
    ...
    *UNCHECKED* void p = allocate to stack ( size )
        // p gets implied qualifiers *STACK* and *WRITABLE*
...
If a variable {\tt v} has both the \TT{*MEM*} and \TT{*WRITABLE*}
qualifiers, you can assign a value to `\TT{next} {\tt v }' to write
the RAM location that {\tt v} caches.

For details on the \TT{*MEM*} and \TT{*WRITABLE*} qualifiers
...
\subsection{The \TT{*MEM*} and \TT{*WRITABLE*} Memory Qualifiers}
