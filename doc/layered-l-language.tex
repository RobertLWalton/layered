...
\subsection{Conversion Assignment Statements}
...
\TT{T-}$xxx$ are the types of \TT{v-}$xxx$.  Such statements are
...
\item If there is a required qualifier \TT{Q} in \TT{QS-src}, it
must also be in \TT{QS-des} (or also be a protected qualifier).
\item If there is a prohibited qualifier \TT{Q} in \TT{QS-des}, it
must also be in \TT{QS-src}.
\item If \TT{T-src} and \TT{T-des} are not the same and an implied
conversion with prototype:
\begin{center}
\TT{Q T-des} {\em result-variable}%
    ~~\TT{=}~~\TT{( qualifiers Q, Q T-src} {\em source-variable} \TT{)}
\end{center}
is defined, that conversion is applied to \TT{v-src} to produce the
value of \TT{v-des}.
\item If \TT{T-src} and \TT{T-des} are not the same and there is
no implied conversion defined, but there is a function prototype
that matches
\begin{center}
\TT{Q-des T-des} {\em result-variable}%
    ~~\TT{=}~~\TT{( Q-src T-src} {\em source-variable} \TT{)}
\end{center}
this conversion is applied.  In the case the function prototype
has the form
\begin{center}
\TT{Q *UNCHECKED* T-des} {\em result-variable}%
    ~~\TT{=}~~\TT{( qualifiers Q, Q T-src} {\em source-variable} \TT{)}
\end{center}
this is referred to as an \TT{*UNCHECKED*} conversion.
\end{enumerate}

Various builtin implied and \TT{*UNCHECKED*} conversions are described
in this document.
