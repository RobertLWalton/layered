...
{\tt function $U$ r = std \ttkey{first enum of} ( type t )} \\
{\tt function $U$ r = std \ttkey{last enum of} ( type t )}

\begin{center}
where $U$ is underlying type of the enumeration type {\tt t}
\end{center}
...
\begin{center}
where $T$ is an {\em enum-type-name} and $B$ is any {\em type-name}
for the base type of $T$
\end{center}
\begin{indpar}
