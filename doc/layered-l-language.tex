...
A \key{conversion} is a simple assignment statement whose
right side is a variable or a constant.  Conversions are
executed by functions with prototypes of the form:
\begin{center} \tt
