...
qualifier (required or prohibited), any actual variable matched to
this will be implicitly given the protection qualifier.  Furthermore,
this is the \underline{only way} a variable may
