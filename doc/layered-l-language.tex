...
\emkey{extern-statement}
	...
	\TT{extern} {\em global-area-abbreviation}
	            \TT{is} {\em global-area-name} \TT{:} \\
	\TT{~~~~}{\em extern-variable-statement}\STAR{} \\
	\end{tabular}
\\[1ex]
\emkey{extern-variable statement}
    ::= \TT{extern} {\em variable-abbreviation} \TT{is} {\em variable-name}
\end{indpar}
...
TBD: memory within global area: stub offset addresses.
...
that is not yet allocated or has been deallocated cause segmentation
faults.
