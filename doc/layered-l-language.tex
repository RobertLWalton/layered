...
integer stored in memory.  However, `\verb|ip1|', `\verb|ip2|',
`\verb|ipp3|', and `\verb|ip3|' reference an address variable, while
`\verb|* ip1|',
`\verb|* ip2|',
`\verb|i2|',
`\verb|** ip3|', and `\verb|* ip3|',
and `\verb|i3|' reference
an {\tt int32} integer variable.
...
{\tt constant stack adr =} {\em some-stack-address} {\tt -> adr ip -> int32;}
\end{indpar}

so that `{\tt ip = \& i}' is a legal statement.  The compiler arranges
