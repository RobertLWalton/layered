...
The blocks in block assignment statements can also be made
unchecked by adding the `\TT{*UNCHECKED}' qualification to the
statement.
...
Conditional assignment statements are similar to block assignment
statements:
...
Lastly loop assignment statements are similar to block assignment
