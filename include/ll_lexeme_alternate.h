...
// This file was copied from ll_lexeme_standard.h
...
# ifndef LL_LEXEME_ALTERNATE_H
# define LL_LEXEME_ALTERNATE_H
...
namespace ll { namespace lexeme { namespace alternate {
    ...
    // Given a min::gen string that encodes an alternate
...
namespace ll { namespace lexeme { namespace alternate {
    ...
    // If ll::lexeme::alternate::default_program is not
    // NULL_STUB, this function does nothing.  Otherwise
    // it creates the alternate lexical program in both
    //
    //		ll::lexeme::default_program
    // and	ll::lexeme::alternate::default_program
    //
    void init_alternate_program ( void );

} } }

# endif // LL_LEXEME_ALTERNATE_H
