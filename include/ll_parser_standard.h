...
// Date:	Sun May  4 05:10:40 AM EDT 2025
//
...
enum {
	...
	// omitting DISabled CODE and MATH selectors.
    FUNCTION_OPERATORS		= 1 << 22,
        // Set standard function operator entries
	// omitting DISabled CODE selectors.
