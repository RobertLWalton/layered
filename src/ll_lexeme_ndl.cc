...
void LEXNDL::translate ( uns32 table_name )
{
    FUNCTION ( "TRANSLATE" );
    ASSERT ( state == INSIDE_TABLE,
             "translate() misplaced" );
    ...
    ci.translate_table_ID = table_name;
}
